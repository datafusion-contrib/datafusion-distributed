...
pub struct TaskData {
    ...
    pub(crate) metrics_tx: Arc<std::sync::Mutex<Option<oneshot::Sender<TaskMetrics>>>>,
    ...
    pub(crate) task_data_metrics: Arc<TaskDataMetrics>,
}
...
#[derive(Debug)]
pub(crate) struct TaskDataMetrics {
...
impl TaskDataMetrics {
    pub(crate) fn new(query_start_time_ns: usize) -> Self {
