...
fn distribute_plan(
    ...
    //
    // TODO: Enable 1->1 collapse for Broadcast by detecting CollectLeft parent and wrapping build
    // child with a caching operator (Similar to [BroadcastExec]).
    if matches!(
...
/// Adds task count for all operators in a stage.
