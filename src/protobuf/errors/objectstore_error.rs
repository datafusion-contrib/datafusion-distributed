...
impl ObjectStoreErrorProto {
    pub fn from_object_store_error(err: &object_store::Error) -> Self {
        match err {
            ...
            object_store::Error::NotImplemented { operation: _, implementer: _} => ObjectStoreErrorProto {
    ...
    pub fn to_object_store_error(&self) -> object_store::Error {
        ...
        match inner {
            ...
            ObjectStoreErrorInnerProto::NotImplemented(_msg) => object_store::Error::NotImplemented { 
