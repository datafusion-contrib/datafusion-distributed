...
pub mod coordinator_to_worker_msg {
    ...
    pub enum Inner {
        ...
        #[prost(bool, tag = "3")]
        WorkUnitEos(bool),
        /// Requests a side-effect-free reservation. This must be the first message in the stream.
        /// The server accepting the RPC response is the reservation acknowledgement; SetPlanRequest
        /// is sent only after that acknowledgement reaches the coordinator.
        #[prost(message, tag = "4")]
        OpenTaskRequest(super::OpenTaskRequest),
    }
}
...
pub struct SetPlanRequest {
    ...
    /// Identifies the accepted OpenTaskRequest that this request commits.
