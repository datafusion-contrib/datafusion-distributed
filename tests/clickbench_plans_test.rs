...
mod tests {
    ...
    async fn test_clickbench_0() -> Result<()> {
        let display = test_clickbench_query(0).await?;
    ...
    async fn test_clickbench_1() -> Result<()> {
        let display = test_clickbench_query(1).await?;
    ...
    async fn test_clickbench_2() -> Result<()> {
        let display = test_clickbench_query(2).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_3() -> Result<()> {
        let display = test_clickbench_query(3).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_4() -> Result<()> {
        let display = test_clickbench_query(4).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_5() -> Result<()> {
        let display = test_clickbench_query(5).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_6() -> Result<()> {
        let display = test_clickbench_query(6).await?;
        assert_snapshot!(display, @"");
        Ok(())
    }
    ...
    async fn test_clickbench_7() -> Result<()> {
        let display = test_clickbench_query(7).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        ...
        └──────────────────────────────────────────────────
          ...
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([AdvEngineID@0], 3), input_partitions=3
    ...
    async fn test_clickbench_8() -> Result<()> {
        let display = test_clickbench_query(8).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_9() -> Result<()> {
        let display = test_clickbench_query(9).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_10() -> Result<()> {
        let display = test_clickbench_query(10).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ SortPreservingMergeExec: [u@1 DESC], fetch=10
        │   SortExec: TopK(fetch=10), expr=[u@1 DESC], preserve_partitioning=[true]
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([MobilePhoneModel@0, alias1@1], 3), input_partitions=3
    ...
    async fn test_clickbench_11() -> Result<()> {
        let display = test_clickbench_query(11).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([MobilePhone@0, MobilePhoneModel@1, alias1@2], 3), input_partitions=3
    ...
    async fn test_clickbench_12() -> Result<()> {
        let display = test_clickbench_query(12).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_13() -> Result<()> {
        let display = test_clickbench_query(13).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ SortPreservingMergeExec: [u@1 DESC], fetch=10
        │   SortExec: TopK(fetch=10), expr=[u@1 DESC], preserve_partitioning=[true]
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([SearchPhrase@0, alias1@1], 3), input_partitions=3
    ...
    async fn test_clickbench_14() -> Result<()> {
        let display = test_clickbench_query(14).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ SortPreservingMergeExec: [c@2 DESC], fetch=10
        │   SortExec: TopK(fetch=10), expr=[c@2 DESC], preserve_partitioning=[true]
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([SearchEngineID@0, SearchPhrase@1], 3), input_partitions=3
    ...
    async fn test_clickbench_15() -> Result<()> {
        let display = test_clickbench_query(15).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_16() -> Result<()> {
        let display = test_clickbench_query(16).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_17() -> Result<()> {
        let display = test_clickbench_query(17).await?;
        assert_snapshot!(display, @"");
        Ok(())
    }
    ...
    async fn test_clickbench_18() -> Result<()> {
        let display = test_clickbench_query(18).await?;
        assert_snapshot!(display, @r#"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_19() -> Result<()> {
        let display = test_clickbench_query(19).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ CoalescePartitionsExec
        │   [Stage 1] => NetworkCoalesceExec: output_partitions=6, input_tasks=2
    ...
    async fn test_clickbench_20() -> Result<()> {
        let display = test_clickbench_query(20).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ ProjectionExec: expr=[count(Int64(1))@0 as count(*)]
        │   AggregateExec: mode=Final, gby=[], aggr=[count(Int64(1))]
    ...
    async fn test_clickbench_21() -> Result<()> {
        let display = test_clickbench_query(21).await?;
        assert_snapshot!(display, @"");
        Ok(())
    }
    ...
    async fn test_clickbench_22() -> Result<()> {
        let display = test_clickbench_query(22).await?;
        assert_snapshot!(display, @"");
        Ok(())
    }
    ...
    async fn test_clickbench_23() -> Result<()> {
        let display = test_clickbench_query(23).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_24() -> Result<()> {
        let display = test_clickbench_query(24).await?;
        assert_snapshot!(display, @"");
        Ok(())
    }
    ...
    async fn test_clickbench_25() -> Result<()> {
        let display = test_clickbench_query(25).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_26() -> Result<()> {
        let display = test_clickbench_query(26).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_27() -> Result<()> {
        let display = test_clickbench_query(27).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([CounterID@0], 3), input_partitions=3
    ...
    async fn test_clickbench_28() -> Result<()> {
        let display = test_clickbench_query(28).await?;
        assert_snapshot!(display, @r#"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ SortPreservingMergeExec: [l@1 DESC], fetch=25
        │   SortExec: TopK(fetch=25), expr=[l@1 DESC], preserve_partitioning=[true]
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([regexp_replace(hits.Referer,Utf8("^https?://(?:www\.)?([^/]+)/.*$"),Utf8("\1"))@0], 3), input_partitions=3
    ...
    async fn test_clickbench_29() -> Result<()> {
        let display = test_clickbench_query(29).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_30() -> Result<()> {
        let display = test_clickbench_query(30).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ SortPreservingMergeExec: [c@2 DESC], fetch=10
        │   SortExec: TopK(fetch=10), expr=[c@2 DESC], preserve_partitioning=[true]
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([SearchEngineID@0, ClientIP@1], 3), input_partitions=3
    ...
    async fn test_clickbench_31() -> Result<()> {
        let display = test_clickbench_query(31).await?;
        assert_snapshot!(display, @"");
        Ok(())
    }
    ...
    async fn test_clickbench_32() -> Result<()> {
        let display = test_clickbench_query(32).await?;
        assert_snapshot!(display, @"");
        Ok(())
    }
    ...
    async fn test_clickbench_33() -> Result<()> {
        let display = test_clickbench_query(33).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ SortPreservingMergeExec: [c@1 DESC], fetch=10
        │   [Stage 2] => NetworkCoalesceExec: output_partitions=6, input_tasks=2
    ...
    async fn test_clickbench_34() -> Result<()> {
        let display = test_clickbench_query(34).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ SortPreservingMergeExec: [c@2 DESC], fetch=10
        │   [Stage 2] => NetworkCoalesceExec: output_partitions=6, input_tasks=2
    ...
    async fn test_clickbench_35() -> Result<()> {
        let display = test_clickbench_query(35).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_36() -> Result<()> {
        let display = test_clickbench_query(36).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([URL@0], 3), input_partitions=3
          │     AggregateExec: mode=Partial, gby=[URL@0 as URL], aggr=[count(Int64(1))]
          │       CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_clickbench_37() -> Result<()> {
        let display = test_clickbench_query(37).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ SortPreservingMergeExec: [pageviews@1 DESC], fetch=10
        │   SortExec: TopK(fetch=10), expr=[pageviews@1 DESC], preserve_partitioning=[true]
    ...
    async fn test_clickbench_38() -> Result<()> {
        let display = test_clickbench_query(38).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
    ...
    async fn test_clickbench_39() -> Result<()> {
        let display = test_clickbench_query(39).await?;
        assert_snapshot!(display, @r#"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        │ GlobalLimitExec: skip=1000, fetch=10
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([TraficSourceID@0, SearchEngineID@1, AdvEngineID@2, CASE WHEN hits.SearchEngineID = Int64(0) AND hits.AdvEngineID = Int64(0) THEN hits.Referer ELSE Utf8("") END@3, URL@4], 3), input_partitions=3
    ...
    async fn test_clickbench_40() -> Result<()> {
        let display = test_clickbench_query(40).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([URLHash@0, EventDate@1], 3), input_partitions=3
    ...
    async fn test_clickbench_41() -> Result<()> {
        let display = test_clickbench_query(41).await?;
        assert_snapshot!(display, @r"
        ┌───── DistributedExec ── Tasks: t0:[p0] 
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([WindowClientWidth@0, WindowClientHeight@1], 3), input_partitions=3
    ...
    async fn test_clickbench_42() -> Result<()> {
        let display = test_clickbench_query(42).await?;
        assert_snapshot!(display, @"");
        Ok(())
    }
    ...
    async fn test_clickbench_query(query_id: usize) -> Result<String> {
        ...
        let query_sql = clickbench::get_test_clickbench_query(query_id)?;
