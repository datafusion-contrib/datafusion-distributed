...
mod tests {
    ...
    async fn test_clickbench_0() -> Result<()> {
        test_clickbench_query(0).await
    }

    #[tokio::test]
    async fn test_clickbench_1() -> Result<()> {
        test_clickbench_query(1).await
    }

    #[tokio::test]
    async fn test_clickbench_2() -> Result<()> {
        test_clickbench_query(2).await
    }
    ...
    async fn test_clickbench_17() -> Result<()> {
        test_clickbench_query(17).await
    }

    #[tokio::test]
    async fn test_clickbench_18() -> Result<()> {
        test_clickbench_query(18).await
    }

    #[tokio::test]
    async fn test_clickbench_19() -> Result<()> {
        test_clickbench_query(19).await
    }

    #[tokio::test]
    async fn test_clickbench_20() -> Result<()> {
        test_clickbench_query(20).await
    }
    ...
    async fn test_clickbench_21() -> Result<()> {
        test_clickbench_query(21).await
    }
    ...
    async fn test_clickbench_22() -> Result<()> {
        test_clickbench_query(22).await
    }

    #[tokio::test]
    async fn test_clickbench_23() -> Result<()> {
        test_clickbench_query(23).await
    }
    ...
    async fn test_clickbench_24() -> Result<()> {
        test_clickbench_query(24).await
    }

    #[tokio::test]
    async fn test_clickbench_25() -> Result<()> {
        test_clickbench_query(25).await
    }

    #[tokio::test]
    async fn test_clickbench_26() -> Result<()> {
        test_clickbench_query(26).await
    }

    #[tokio::test]
    async fn test_clickbench_27() -> Result<()> {
        test_clickbench_query(27).await
    }

    #[tokio::test]
    async fn test_clickbench_28() -> Result<()> {
        test_clickbench_query(28).await
    }

    #[tokio::test]
    async fn test_clickbench_29() -> Result<()> {
        test_clickbench_query(29).await
    }

    #[tokio::test]
    async fn test_clickbench_30() -> Result<()> {
        test_clickbench_query(30).await
    }
    ...
    async fn test_clickbench_31() -> Result<()> {
        test_clickbench_query(31).await
    }
    ...
    async fn test_clickbench_42() -> Result<()> {
        test_clickbench_query(42).await
    }
    ...
    async fn test_clickbench_query(query_id: usize) -> Result<()> {
