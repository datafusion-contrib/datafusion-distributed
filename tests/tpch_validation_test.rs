...
mod tests {
    ...
    async fn test_tpch_1() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceTasksExec read_from=Stage 2, output_partitions=30, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
          ...
          │         NetworkHashShuffleExec read_from=Stage 1, output_partitions=15, n_tasks=2, input_tasks=2
          └──────────────────────────────────────────────────
            ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
            │ RepartitionExec: partitioning=Hash([l_returnflag@0, l_linestatus@1], 30), input_partitions=8
    ...
    async fn test_tpch_2() -> Result<(), Box<dyn Error>> {
        let plan = plan_tpch_query(2).await?;
        assert_snapshot!(plan, @r"
        ┌───── Stage 8   Tasks: t0:[p0] 
        │ SortPreservingMergeExec: [s_acctbal@0 DESC, n_name@2 ASC NULLS LAST, s_name@1 ASC NULLS LAST, p_partkey@3 ASC NULLS LAST]
        │   NetworkCoalesceTasksExec read_from=Stage 7, output_partitions=30, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 7   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
          ...
          │         CoalesceBatchesExec: target_batch_size=8192
          │           NetworkHashShuffleExec read_from=Stage 3, output_partitions=15, n_tasks=2, input_tasks=1
          │         CoalesceBatchesExec: target_batch_size=8192
          │           NetworkHashShuffleExec read_from=Stage 6, output_partitions=15, n_tasks=2, input_tasks=2
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([p_partkey@0, ps_supplycost@7], 30), input_partitions=15
            │   CoalesceBatchesExec: target_batch_size=8192
            ...
            │         NetworkCoalesceTasksExec read_from=Stage 1, output_partitions=30, input_tasks=2
            ...
            │             CoalescePartitionsExec
            │               DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet], [/testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet], [/testdata/tpch/data/nation/13.parquet, /testdata/tpch/data/nation/14.parquet], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet], [/testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet], ...]}, projection=[n_nationkey, n_name, n_regionkey], file_type=parquet
            ...
            │                       CoalescePartitionsExec
            │                         NetworkCoalesceTasksExec read_from=Stage 2, output_partitions=30, input_tasks=2
            │                       DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..45919], [/testdata/tpch/data/partsupp/10.parquet:45919..748125, /testdata/tpch/data/partsupp/11.parquet:0..97221], [/testdata/tpch/data/partsupp/11.parquet:97221..744689, /testdata/tpch/data/partsupp/12.parquet:0..151959], [/testdata/tpch/data/partsupp/12.parquet:151959..749068, /testdata/tpch/data/partsupp/13.parquet:0..202318], [/testdata/tpch/data/partsupp/13.parquet:202318..750296, /testdata/tpch/data/partsupp/14.parquet:0..251449], ...]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: r_name@1 = EUROPE, projection=[r_regionkey@0]
              │     RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
              │       PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
              │         DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/region/1.parquet, /testdata/tpch/data/region/10.parquet], [/testdata/tpch/data/region/11.parquet, /testdata/tpch/data/region/12.parquet], [/testdata/tpch/data/region/13.parquet, /testdata/tpch/data/region/14.parquet], [/testdata/tpch/data/region/15.parquet, /testdata/tpch/data/region/16.parquet], [/testdata/tpch/data/region/2.parquet, /testdata/tpch/data/region/3.parquet], ...]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = EUROPE, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= EUROPE AND EUROPE <= r_name_max@1, required_guarantees=[r_name in (EUROPE)]
              └──────────────────────────────────────────────────
              ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ CoalesceBatchesExec: target_batch_size=8192
              ...
              │     RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
              │       PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
              │         DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/part/1.parquet, /testdata/tpch/data/part/10.parquet], [/testdata/tpch/data/part/11.parquet, /testdata/tpch/data/part/12.parquet], [/testdata/tpch/data/part/13.parquet, /testdata/tpch/data/part/14.parquet], [/testdata/tpch/data/part/15.parquet, /testdata/tpch/data/part/16.parquet], [/testdata/tpch/data/part/2.parquet, /testdata/tpch/data/part/3.parquet], ...]}, projection=[p_partkey, p_mfgr, p_type, p_size], file_type=parquet, predicate=p_size@3 = 15 AND p_type@2 LIKE %BRASS, pruning_predicate=p_size_null_count@2 != row_count@3 AND p_size_min@0 <= 15 AND 15 <= p_size_max@1, required_guarantees=[p_size in (15)]
              └──────────────────────────────────────────────────
            ┌───── Stage 6   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
            │ RepartitionExec: partitioning=Hash([ps_partkey@1, min(partsupp.ps_supplycost)@0], 30), input_partitions=15
            ...
            │       CoalesceBatchesExec: target_batch_size=8192
            │         NetworkHashShuffleExec read_from=Stage 5, output_partitions=15, n_tasks=2, input_tasks=1
            └──────────────────────────────────────────────────
              ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ RepartitionExec: partitioning=Hash([ps_partkey@0], 30), input_partitions=15
              ...
              │         CoalescePartitionsExec
              │           NetworkCoalesceTasksExec read_from=Stage 4, output_partitions=30, input_tasks=2
              ...
              │               CoalescePartitionsExec
              │                 DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet], [/testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet], [/testdata/tpch/data/nation/13.parquet, /testdata/tpch/data/nation/14.parquet], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet], [/testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet], ...]}, projection=[n_nationkey, n_regionkey], file_type=parquet
              ...
              │                     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..45919], [/testdata/tpch/data/partsupp/10.parquet:45919..748125, /testdata/tpch/data/partsupp/11.parquet:0..97221], [/testdata/tpch/data/partsupp/11.parquet:97221..744689, /testdata/tpch/data/partsupp/12.parquet:0..151959], [/testdata/tpch/data/partsupp/12.parquet:151959..749068, /testdata/tpch/data/partsupp/13.parquet:0..202318], [/testdata/tpch/data/partsupp/13.parquet:202318..750296, /testdata/tpch/data/partsupp/14.parquet:0..251449], ...]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
              └──────────────────────────────────────────────────
                ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
                │ CoalesceBatchesExec: target_batch_size=8192
                │   FilterExec: r_name@1 = EUROPE, projection=[r_regionkey@0]
                │     RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
                │       PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
    ...
    async fn test_tpch_3() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([l_orderkey@0, o_orderdate@1, o_shippriority@2], 30), input_partitions=15
            ...
            │         CoalescePartitionsExec
            │           NetworkCoalesceTasksExec read_from=Stage 2, output_partitions=15, input_tasks=1
            │         CoalesceBatchesExec: target_batch_size=8192
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
              │ CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_4() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceTasksExec read_from=Stage 3, output_partitions=30, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkHashShuffleExec read_from=Stage 2, output_partitions=15, n_tasks=2, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([o_orderpriority@0], 30), input_partitions=15
            ...
            │         CoalescePartitionsExec
            │           NetworkCoalesceTasksExec read_from=Stage 1, output_partitions=16, input_tasks=2
            │         CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_5() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceTasksExec read_from=Stage 5, output_partitions=30, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkHashShuffleExec read_from=Stage 4, output_partitions=15, n_tasks=2, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([n_name@0], 30), input_partitions=15
            ...
            │                         CoalescePartitionsExec
            │                           NetworkCoalesceTasksExec read_from=Stage 3, output_partitions=15, input_tasks=1
            │                         DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..139666], [/testdata/tpch/data/lineitem/10.parquet:139666..2247315, /testdata/tpch/data/lineitem/11.parquet:0..295647], [/testdata/tpch/data/lineitem/11.parquet:295647..2257665, /testdata/tpch/data/lineitem/12.parquet:0..441278], [/testdata/tpch/data/lineitem/12.parquet:441278..2246562, /testdata/tpch/data/lineitem/13.parquet:0..598012], [/testdata/tpch/data/lineitem/13.parquet:598012..2280549, /testdata/tpch/data/lineitem/14.parquet:0..720759], ...]}, projection=[l_orderkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ CoalesceBatchesExec: target_batch_size=8192
              ...
              │     RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
              │       PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
              │         DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/region/1.parquet, /testdata/tpch/data/region/10.parquet], [/testdata/tpch/data/region/11.parquet, /testdata/tpch/data/region/12.parquet], [/testdata/tpch/data/region/13.parquet, /testdata/tpch/data/region/14.parquet], [/testdata/tpch/data/region/15.parquet, /testdata/tpch/data/region/16.parquet], [/testdata/tpch/data/region/2.parquet, /testdata/tpch/data/region/3.parquet], ...]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = ASIA, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= ASIA AND ASIA <= r_name_max@1, required_guarantees=[r_name in (ASIA)]
              └──────────────────────────────────────────────────
              ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
              ...
              │       CoalescePartitionsExec
              │         NetworkCoalesceTasksExec read_from=Stage 2, output_partitions=16, input_tasks=2
              │       RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=8
              │         DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet], [/testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet], [/testdata/tpch/data/customer/13.parquet, /testdata/tpch/data/customer/14.parquet], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet], [/testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet], ...]}, projection=[c_custkey, c_nationkey], file_type=parquet
              └──────────────────────────────────────────────────
                ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7] t1:[p8,p9,p10,p11,p12,p13,p14,p15] 
                │ CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_7() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceTasksExec read_from=Stage 6, output_partitions=30, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 6   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([supp_nation@0, cust_nation@1, l_year@2], 30), input_partitions=15
            ...
            │                     CoalescePartitionsExec
            │                       NetworkCoalesceTasksExec read_from=Stage 4, output_partitions=15, input_tasks=1
            │                     RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=8
            │                       DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet], [/testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet], [/testdata/tpch/data/customer/13.parquet, /testdata/tpch/data/customer/14.parquet], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet], [/testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet], ...]}, projection=[c_custkey, c_nationkey], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              ...
              └──────────────────────────────────────────────────
              ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
              │ CoalesceBatchesExec: target_batch_size=8192
              ...
              │     CoalescePartitionsExec
              │       NetworkCoalesceTasksExec read_from=Stage 3, output_partitions=15, input_tasks=1
              │     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..54024], [/testdata/tpch/data/orders/10.parquet:54024..817463, /testdata/tpch/data/orders/11.parquet:0..108855], [/testdata/tpch/data/orders/11.parquet:108855..816070, /testdata/tpch/data/orders/12.parquet:0..165079], [/testdata/tpch/data/orders/12.parquet:165079..820827, /testdata/tpch/data/orders/13.parquet:0..216546], [/testdata/tpch/data/orders/13.parquet:216546..821995, /testdata/tpch/data/orders/14.parquet:0..266845], ...]}, projection=[o_orderkey, o_custkey], file_type=parquet
              └──────────────────────────────────────────────────
                ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
                │ CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_8() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceTasksExec read_from=Stage 8, output_partitions=30, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 8   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkHashShuffleExec read_from=Stage 7, output_partitions=15, n_tasks=2, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 7   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([o_year@0], 30), input_partitions=15
            ...
            │                 CoalescePartitionsExec
            │                   DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet], [/testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet], [/testdata/tpch/data/nation/13.parquet, /testdata/tpch/data/nation/14.parquet], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet], [/testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet], ...]}, projection=[n_nationkey, n_name], file_type=parquet
            ...
            │                           CoalesceBatchesExec: target_batch_size=8192
            │                             NetworkHashShuffleExec read_from=Stage 5, output_partitions=15, n_tasks=1, input_tasks=2
            │                           CoalesceBatchesExec: target_batch_size=8192
            │                             NetworkHashShuffleExec read_from=Stage 6, output_partitions=15, n_tasks=1, input_tasks=2
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ CoalesceBatchesExec: target_batch_size=8192
              ...
              │     RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
              │       PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
              │         DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/region/1.parquet, /testdata/tpch/data/region/10.parquet], [/testdata/tpch/data/region/11.parquet, /testdata/tpch/data/region/12.parquet], [/testdata/tpch/data/region/13.parquet, /testdata/tpch/data/region/14.parquet], [/testdata/tpch/data/region/15.parquet, /testdata/tpch/data/region/16.parquet], [/testdata/tpch/data/region/2.parquet, /testdata/tpch/data/region/3.parquet], ...]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = AMERICA, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= AMERICA AND AMERICA <= r_name_max@1, required_guarantees=[r_name in (AMERICA)]
              └──────────────────────────────────────────────────
              ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ RepartitionExec: partitioning=Hash([o_custkey@3], 15), input_partitions=15
              ...
              │         CoalesceBatchesExec: target_batch_size=8192
              │           NetworkHashShuffleExec read_from=Stage 2, output_partitions=15, n_tasks=2, input_tasks=2
              │         CoalesceBatchesExec: target_batch_size=8192
              │           NetworkHashShuffleExec read_from=Stage 4, output_partitions=15, n_tasks=2, input_tasks=1
              └──────────────────────────────────────────────────
                ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
                │ RepartitionExec: partitioning=Hash([o_orderkey@0], 30), input_partitions=8
                │   CoalesceBatchesExec: target_batch_size=8192
                ...
                └──────────────────────────────────────────────────
                ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
                │ RepartitionExec: partitioning=Hash([l_orderkey@0], 30), input_partitions=15
                ...
                │             CoalescePartitionsExec
                │               NetworkCoalesceTasksExec read_from=Stage 3, output_partitions=30, input_tasks=2
                │             DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..139666], [/testdata/tpch/data/lineitem/10.parquet:139666..2247315, /testdata/tpch/data/lineitem/11.parquet:0..295647], [/testdata/tpch/data/lineitem/11.parquet:295647..2257665, /testdata/tpch/data/lineitem/12.parquet:0..441278], [/testdata/tpch/data/lineitem/12.parquet:441278..2246562, /testdata/tpch/data/lineitem/13.parquet:0..598012], [/testdata/tpch/data/lineitem/13.parquet:598012..2280549, /testdata/tpch/data/lineitem/14.parquet:0..720759], ...]}, projection=[l_orderkey, l_partkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet
                └──────────────────────────────────────────────────
                  ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
                  │ CoalesceBatchesExec: target_batch_size=8192
                  ...
                  └──────────────────────────────────────────────────
              ┌───── Stage 6   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ RepartitionExec: partitioning=Hash([c_custkey@0], 15), input_partitions=15
              │   RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
              │     PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
              │       DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet], [/testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet], [/testdata/tpch/data/customer/13.parquet, /testdata/tpch/data/customer/14.parquet], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet], [/testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet], ...]}, projection=[c_custkey, c_nationkey], file_type=parquet
              └──────────────────────────────────────────────────
    ...
    async fn test_tpch_9() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkHashShuffleExec read_from=Stage 6, output_partitions=15, n_tasks=2, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 6   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([nation@0, o_year@1], 30), input_partitions=15
            ...
            │                 CoalesceBatchesExec: target_batch_size=8192
            │                   NetworkHashShuffleExec read_from=Stage 1, output_partitions=15, n_tasks=1, input_tasks=2
            │                 CoalesceBatchesExec: target_batch_size=8192
            │                   NetworkHashShuffleExec read_from=Stage 5, output_partitions=15, n_tasks=1, input_tasks=2
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ RepartitionExec: partitioning=Hash([o_orderkey@0], 15), input_partitions=8
              │   PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,p6,p7] 
              │     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..54024], [/testdata/tpch/data/orders/10.parquet:54024..817463, /testdata/tpch/data/orders/11.parquet:0..108855], [/testdata/tpch/data/orders/11.parquet:108855..816070, /testdata/tpch/data/orders/12.parquet:0..165079], [/testdata/tpch/data/orders/12.parquet:165079..820827, /testdata/tpch/data/orders/13.parquet:0..216546], [/testdata/tpch/data/orders/13.parquet:216546..821995, /testdata/tpch/data/orders/14.parquet:0..266845], ...]}, projection=[o_orderkey, o_orderdate], file_type=parquet
              └──────────────────────────────────────────────────
              ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ RepartitionExec: partitioning=Hash([l_orderkey@0], 15), input_partitions=15
              │   CoalesceBatchesExec: target_batch_size=8192
              ...
              │         NetworkHashShuffleExec read_from=Stage 3, output_partitions=15, n_tasks=2, input_tasks=1
              │       CoalesceBatchesExec: target_batch_size=8192
              │         NetworkHashShuffleExec read_from=Stage 4, output_partitions=15, n_tasks=2, input_tasks=2
              └──────────────────────────────────────────────────
                ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
                │ RepartitionExec: partitioning=Hash([l_suppkey@2, l_partkey@1], 30), input_partitions=15
                ...
                │             CoalescePartitionsExec
                │               NetworkCoalesceTasksExec read_from=Stage 2, output_partitions=30, input_tasks=2
                │             DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..139666], [/testdata/tpch/data/lineitem/10.parquet:139666..2247315, /testdata/tpch/data/lineitem/11.parquet:0..295647], [/testdata/tpch/data/lineitem/11.parquet:295647..2257665, /testdata/tpch/data/lineitem/12.parquet:0..441278], [/testdata/tpch/data/lineitem/12.parquet:441278..2246562, /testdata/tpch/data/lineitem/13.parquet:0..598012], [/testdata/tpch/data/lineitem/13.parquet:598012..2280549, /testdata/tpch/data/lineitem/14.parquet:0..720759], ...]}, projection=[l_orderkey, l_partkey, l_suppkey, l_quantity, l_extendedprice, l_discount], file_type=parquet
                └──────────────────────────────────────────────────
                  ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
                  │ CoalesceBatchesExec: target_batch_size=8192
                  ...
                  │     RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
                  │       PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
                  │         DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/part/1.parquet, /testdata/tpch/data/part/10.parquet], [/testdata/tpch/data/part/11.parquet, /testdata/tpch/data/part/12.parquet], [/testdata/tpch/data/part/13.parquet, /testdata/tpch/data/part/14.parquet], [/testdata/tpch/data/part/15.parquet, /testdata/tpch/data/part/16.parquet], [/testdata/tpch/data/part/2.parquet, /testdata/tpch/data/part/3.parquet], ...]}, projection=[p_partkey, p_name], file_type=parquet, predicate=p_name@1 LIKE %green%
                  └──────────────────────────────────────────────────
                ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
                │ RepartitionExec: partitioning=Hash([ps_suppkey@1, ps_partkey@0], 30), input_partitions=8
                │   PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,p6,p7] 
                │     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..45919], [/testdata/tpch/data/partsupp/10.parquet:45919..748125, /testdata/tpch/data/partsupp/11.parquet:0..97221], [/testdata/tpch/data/partsupp/11.parquet:97221..744689, /testdata/tpch/data/partsupp/12.parquet:0..151959], [/testdata/tpch/data/partsupp/12.parquet:151959..749068, /testdata/tpch/data/partsupp/13.parquet:0..202318], [/testdata/tpch/data/partsupp/13.parquet:202318..750296, /testdata/tpch/data/partsupp/14.parquet:0..251449], ...]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
                └──────────────────────────────────────────────────
        ");
    ...
    async fn test_tpch_10() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([c_custkey@0, c_name@1, c_acctbal@2, c_phone@3, n_name@4, c_address@5, c_comment@6], 30), input_partitions=15
    ...
    async fn test_tpch_11() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceTasksExec read_from=Stage 5, output_partitions=15, input_tasks=1
        └──────────────────────────────────────────────────
          ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
          ...
          │         CoalesceBatchesExec: target_batch_size=8192
          │           NetworkHashShuffleExec read_from=Stage 4, output_partitions=15, n_tasks=1, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
            ...
            │             CoalescePartitionsExec
            │               DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet], [/testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet], [/testdata/tpch/data/supplier/13.parquet, /testdata/tpch/data/supplier/14.parquet], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet], [/testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet], ...]}, projection=[s_suppkey, s_nationkey], file_type=parquet
            │             DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..45919], [/testdata/tpch/data/partsupp/10.parquet:45919..748125, /testdata/tpch/data/partsupp/11.parquet:0..97221], [/testdata/tpch/data/partsupp/11.parquet:97221..744689, /testdata/tpch/data/partsupp/12.parquet:0..151959], [/testdata/tpch/data/partsupp/12.parquet:151959..749068, /testdata/tpch/data/partsupp/13.parquet:0..202318], [/testdata/tpch/data/partsupp/13.parquet:202318..750296, /testdata/tpch/data/partsupp/14.parquet:0..251449], ...]}, projection=[ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ CoalesceBatchesExec: target_batch_size=8192
              ...
              └──────────────────────────────────────────────────
            ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
            │ RepartitionExec: partitioning=Hash([ps_partkey@0], 15), input_partitions=15
            ...
            │               CoalescePartitionsExec
            │                 DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet], [/testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet], [/testdata/tpch/data/supplier/13.parquet, /testdata/tpch/data/supplier/14.parquet], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet], [/testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet], ...]}, projection=[s_suppkey, s_nationkey], file_type=parquet
            │               DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..45919], [/testdata/tpch/data/partsupp/10.parquet:45919..748125, /testdata/tpch/data/partsupp/11.parquet:0..97221], [/testdata/tpch/data/partsupp/11.parquet:97221..744689, /testdata/tpch/data/partsupp/12.parquet:0..151959], [/testdata/tpch/data/partsupp/12.parquet:151959..749068, /testdata/tpch/data/partsupp/13.parquet:0..202318], [/testdata/tpch/data/partsupp/13.parquet:202318..750296, /testdata/tpch/data/partsupp/14.parquet:0..251449], ...]}, projection=[ps_partkey, ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: n_name@1 = GERMANY, projection=[n_nationkey@0]
    ...
    async fn test_tpch_12() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkHashShuffleExec read_from=Stage 3, output_partitions=15, n_tasks=2, input_tasks=2
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
            │ RepartitionExec: partitioning=Hash([l_shipmode@0], 30), input_partitions=15
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
              │ RepartitionExec: partitioning=Hash([l_orderkey@0], 30), input_partitions=8
              │   CoalesceBatchesExec: target_batch_size=8192
              ...
              │ RepartitionExec: partitioning=Hash([o_orderkey@0], 30), input_partitions=8
              │   PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,p6,p7] 
              │     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..54024], [/testdata/tpch/data/orders/10.parquet:54024..817463, /testdata/tpch/data/orders/11.parquet:0..108855], [/testdata/tpch/data/orders/11.parquet:108855..816070, /testdata/tpch/data/orders/12.parquet:0..165079], [/testdata/tpch/data/orders/12.parquet:165079..820827, /testdata/tpch/data/orders/13.parquet:0..216546], [/testdata/tpch/data/orders/13.parquet:216546..821995, /testdata/tpch/data/orders/14.parquet:0..266845], ...]}, projection=[o_orderkey, o_orderpriority], file_type=parquet
              └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
    ...
    async fn test_tpch_13() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
            │ RepartitionExec: partitioning=Hash([c_count@0], 30), input_partitions=15
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ RepartitionExec: partitioning=Hash([c_custkey@0], 30), input_partitions=15
              ...
              │             NetworkCoalesceTasksExec read_from=Stage 1, output_partitions=16, input_tasks=2
              │           RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=8
              │             DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet], [/testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet], [/testdata/tpch/data/customer/13.parquet, /testdata/tpch/data/customer/14.parquet], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet], [/testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet], ...]}, projection=[c_custkey], file_type=parquet
              └──────────────────────────────────────────────────
                ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7] t1:[p8,p9,p10,p11,p12,p13,p14,p15] 
                │ CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_14() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
            │ RepartitionExec: partitioning=Hash([p_partkey@0], 30), input_partitions=15
            │   RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
            │     PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
            │       DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/part/1.parquet, /testdata/tpch/data/part/10.parquet], [/testdata/tpch/data/part/11.parquet, /testdata/tpch/data/part/12.parquet], [/testdata/tpch/data/part/13.parquet, /testdata/tpch/data/part/14.parquet], [/testdata/tpch/data/part/15.parquet, /testdata/tpch/data/part/16.parquet], [/testdata/tpch/data/part/2.parquet, /testdata/tpch/data/part/3.parquet], ...]}, projection=[p_partkey, p_type], file_type=parquet
            └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
            │ RepartitionExec: partitioning=Hash([l_partkey@0], 30), input_partitions=8
            │   CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_15() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │           CoalescePartitionsExec
          │             DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet], [/testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet], [/testdata/tpch/data/supplier/13.parquet, /testdata/tpch/data/supplier/14.parquet], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet], [/testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet], ...]}, projection=[s_suppkey, s_name, s_address, s_phone], file_type=parquet
          ...
          │               CoalesceBatchesExec: target_batch_size=8192
          │                 NetworkHashShuffleExec read_from=Stage 3, output_partitions=15, n_tasks=1, input_tasks=2
          └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
              │ RepartitionExec: partitioning=Hash([l_suppkey@0], 30), input_partitions=8
              ...
              └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([l_suppkey@0], 15), input_partitions=8
            │   AggregateExec: mode=Partial, gby=[l_suppkey@0 as l_suppkey], aggr=[sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)]
            │     CoalesceBatchesExec: target_batch_size=8192
            │       FilterExec: l_shipdate@3 >= 1996-01-01 AND l_shipdate@3 < 1996-04-01, projection=[l_suppkey@0, l_extendedprice@1, l_discount@2]
            │         PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,p6,p7] 
    ...
    async fn test_tpch_16() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
            │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2], 30), input_partitions=15
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2, alias1@3], 30), input_partitions=15
              ...
              │               CoalescePartitionsExec
              │                 NetworkCoalesceTasksExec read_from=Stage 2, output_partitions=30, input_tasks=2
              │               DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..45919], [/testdata/tpch/data/partsupp/10.parquet:45919..748125, /testdata/tpch/data/partsupp/11.parquet:0..97221], [/testdata/tpch/data/partsupp/11.parquet:97221..744689, /testdata/tpch/data/partsupp/12.parquet:0..151959], [/testdata/tpch/data/partsupp/12.parquet:151959..749068, /testdata/tpch/data/partsupp/13.parquet:0..202318], [/testdata/tpch/data/partsupp/13.parquet:202318..750296, /testdata/tpch/data/partsupp/14.parquet:0..251449], ...]}, projection=[ps_partkey, ps_suppkey], file_type=parquet
              └──────────────────────────────────────────────────
                ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
                │ CoalesceBatchesExec: target_batch_size=8192
                ...
                │     RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
                │       PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
                │         DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet], [/testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet], [/testdata/tpch/data/supplier/13.parquet, /testdata/tpch/data/supplier/14.parquet], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet], [/testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet], ...]}, projection=[s_suppkey, s_comment], file_type=parquet, predicate=s_comment@1 LIKE %Customer%Complaints%
                └──────────────────────────────────────────────────
                ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
                │ CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_17() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([p_partkey@2], 30), input_partitions=15
            ...
            │         CoalescePartitionsExec
            │           NetworkCoalesceTasksExec read_from=Stage 1, output_partitions=30, input_tasks=2
            │         DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..139666], [/testdata/tpch/data/lineitem/10.parquet:139666..2247315, /testdata/tpch/data/lineitem/11.parquet:0..295647], [/testdata/tpch/data/lineitem/11.parquet:295647..2257665, /testdata/tpch/data/lineitem/12.parquet:0..441278], [/testdata/tpch/data/lineitem/12.parquet:441278..2246562, /testdata/tpch/data/lineitem/13.parquet:0..598012], [/testdata/tpch/data/lineitem/13.parquet:598012..2280549, /testdata/tpch/data/lineitem/14.parquet:0..720759], ...]}, projection=[l_partkey, l_quantity, l_extendedprice], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ CoalesceBatchesExec: target_batch_size=8192
            ...
            │     PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,p6,p7] 
            │       DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..139666], [/testdata/tpch/data/lineitem/10.parquet:139666..2247315, /testdata/tpch/data/lineitem/11.parquet:0..295647], [/testdata/tpch/data/lineitem/11.parquet:295647..2257665, /testdata/tpch/data/lineitem/12.parquet:0..441278], [/testdata/tpch/data/lineitem/12.parquet:441278..2246562, /testdata/tpch/data/lineitem/13.parquet:0..598012], [/testdata/tpch/data/lineitem/13.parquet:598012..2280549, /testdata/tpch/data/lineitem/14.parquet:0..720759], ...]}, projection=[l_partkey, l_quantity], file_type=parquet
            └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_18() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 7   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([c_name@0, c_custkey@1, o_orderkey@2, o_orderdate@3, o_totalprice@4], 30), input_partitions=15
            ...
            └──────────────────────────────────────────────────
              ...
              └──────────────────────────────────────────────────
                ...
                │     PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,p6,p7] 
                │       DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..139666], [/testdata/tpch/data/lineitem/10.parquet:139666..2247315, /testdata/tpch/data/lineitem/11.parquet:0..295647], [/testdata/tpch/data/lineitem/11.parquet:295647..2257665, /testdata/tpch/data/lineitem/12.parquet:0..441278], [/testdata/tpch/data/lineitem/12.parquet:441278..2246562, /testdata/tpch/data/lineitem/13.parquet:0..598012], [/testdata/tpch/data/lineitem/13.parquet:598012..2280549, /testdata/tpch/data/lineitem/14.parquet:0..720759], ...]}, projection=[l_orderkey, l_quantity], file_type=parquet
                └──────────────────────────────────────────────────
              ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ RepartitionExec: partitioning=Hash([o_orderkey@2], 15), input_partitions=15
              │   CoalesceBatchesExec: target_batch_size=8192
              ...
              └──────────────────────────────────────────────────
                ...
                │   RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
                │     PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
                │       DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet], [/testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet], [/testdata/tpch/data/customer/13.parquet, /testdata/tpch/data/customer/14.parquet], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet], [/testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet], ...]}, projection=[c_custkey, c_name], file_type=parquet
                └──────────────────────────────────────────────────
                ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] t1:[p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59] 
                │ RepartitionExec: partitioning=Hash([o_custkey@1], 30), input_partitions=8
                │   PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,p6,p7] 
                │     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..54024], [/testdata/tpch/data/orders/10.parquet:54024..817463, /testdata/tpch/data/orders/11.parquet:0..108855], [/testdata/tpch/data/orders/11.parquet:108855..816070, /testdata/tpch/data/orders/12.parquet:0..165079], [/testdata/tpch/data/orders/12.parquet:165079..820827, /testdata/tpch/data/orders/13.parquet:0..216546], [/testdata/tpch/data/orders/13.parquet:216546..821995, /testdata/tpch/data/orders/14.parquet:0..266845], ...]}, projection=[o_orderkey, o_custkey, o_totalprice, o_orderdate], file_type=parquet
                └──────────────────────────────────────────────────
              ┌───── Stage 6   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ RepartitionExec: partitioning=Hash([l_orderkey@0], 15), input_partitions=8
              │   PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,p6,p7] 
              │     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..139666], [/testdata/tpch/data/lineitem/10.parquet:139666..2247315, /testdata/tpch/data/lineitem/11.parquet:0..295647], [/testdata/tpch/data/lineitem/11.parquet:295647..2257665, /testdata/tpch/data/lineitem/12.parquet:0..441278], [/testdata/tpch/data/lineitem/12.parquet:441278..2246562, /testdata/tpch/data/lineitem/13.parquet:0..598012], [/testdata/tpch/data/lineitem/13.parquet:598012..2280549, /testdata/tpch/data/lineitem/14.parquet:0..720759], ...]}, projection=[l_orderkey, l_quantity], file_type=parquet
              └──────────────────────────────────────────────────
        ");
    ...
    async fn test_tpch_20() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceTasksExec read_from=Stage 6, output_partitions=15, input_tasks=1
        └──────────────────────────────────────────────────
          ┌───── Stage 6   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
          ...
          │       CoalescePartitionsExec
          │         NetworkCoalesceTasksExec read_from=Stage 2, output_partitions=8, input_tasks=1
          │       CoalesceBatchesExec: target_batch_size=8192
          ...
          │                 NetworkHashShuffleExec read_from=Stage 5, output_partitions=15, n_tasks=1, input_tasks=2
          └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7] 
            │ CoalesceBatchesExec: target_batch_size=8192
            │   HashJoinExec: mode=CollectLeft, join_type=Inner, on=[(n_nationkey@0, s_nationkey@3)], projection=[s_suppkey@1, s_name@2, s_address@3]
            │     CoalescePartitionsExec
            │       NetworkCoalesceTasksExec read_from=Stage 1, output_partitions=30, input_tasks=2
            │     DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet], [/testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet], [/testdata/tpch/data/supplier/13.parquet, /testdata/tpch/data/supplier/14.parquet], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet], [/testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet], ...]}, projection=[s_suppkey, s_name, s_address, s_nationkey], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ CoalesceBatchesExec: target_batch_size=8192
              ...
              │     RepartitionExec: partitioning=RoundRobinBatch(15), input_partitions=4
              │       PartitionIsolatorExec Tasks: t0:[p0,p1,p2,p3,__,__,__,__] t1:[__,__,__,__,p0,p1,p2,p3] 
              │         DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet], [/testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet], [/testdata/tpch/data/nation/13.parquet, /testdata/tpch/data/nation/14.parquet], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet], [/testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet], ...]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = CANADA, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= CANADA AND CANADA <= n_name_max@1, required_guarantees=[n_name in (CANADA)]
              └──────────────────────────────────────────────────
            ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
            │ CoalesceBatchesExec: target_batch_size=8192
            ...
            │     CoalescePartitionsExec
            │       NetworkCoalesceTasksExec read_from=Stage 3, output_partitions=30, input_tasks=2
            │     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..45919], [/testdata/tpch/data/partsupp/10.parquet:45919..748125, /testdata/tpch/data/partsupp/11.parquet:0..97221], [/testdata/tpch/data/partsupp/11.parquet:97221..744689, /testdata/tpch/data/partsupp/12.parquet:0..151959], [/testdata/tpch/data/partsupp/12.parquet:151959..749068, /testdata/tpch/data/partsupp/13.parquet:0..202318], [/testdata/tpch/data/partsupp/13.parquet:202318..750296, /testdata/tpch/data/partsupp/14.parquet:0..251449], ...]}, projection=[ps_partkey, ps_suppkey, ps_availqty], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
              │ CoalesceBatchesExec: target_batch_size=8192
              ...
              └──────────────────────────────────────────────────
            ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([l_partkey@0, l_suppkey@1], 15), input_partitions=8
    ...
    async fn test_tpch_21() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([s_name@0], 30), input_partitions=15
            ...
            └──────────────────────────────────────────────────
              ...
              │     CoalescePartitionsExec
              │       NetworkCoalesceTasksExec read_from=Stage 3, output_partitions=15, input_tasks=1
              │     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..139666], [/testdata/tpch/data/lineitem/10.parquet:139666..2247315, /testdata/tpch/data/lineitem/11.parquet:0..295647], [/testdata/tpch/data/lineitem/11.parquet:295647..2257665, /testdata/tpch/data/lineitem/12.parquet:0..441278], [/testdata/tpch/data/lineitem/12.parquet:441278..2246562, /testdata/tpch/data/lineitem/13.parquet:0..598012], [/testdata/tpch/data/lineitem/13.parquet:598012..2280549, /testdata/tpch/data/lineitem/14.parquet:0..720759], ...]}, projection=[l_orderkey, l_suppkey], file_type=parquet
              └──────────────────────────────────────────────────
                ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] 
                │ CoalesceBatchesExec: target_batch_size=8192
                ...
                │             CoalescePartitionsExec
                │               DataSourceExec: file_groups={8 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet], [/testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet], [/testdata/tpch/data/supplier/13.parquet, /testdata/tpch/data/supplier/14.parquet], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet], [/testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet], ...]}, projection=[s_suppkey, s_name, s_nationkey], file_type=parquet
                │             CoalesceBatchesExec: target_batch_size=8192
                │               FilterExec: l_receiptdate@3 > l_commitdate@2, projection=[l_orderkey@0, l_suppkey@1]
                │                 DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..139666], [/testdata/tpch/data/lineitem/10.parquet:139666..2247315, /testdata/tpch/data/lineitem/11.parquet:0..295647], [/testdata/tpch/data/lineitem/11.parquet:295647..2257665, /testdata/tpch/data/lineitem/12.parquet:0..441278], [/testdata/tpch/data/lineitem/12.parquet:441278..2246562, /testdata/tpch/data/lineitem/13.parquet:0..598012], [/testdata/tpch/data/lineitem/13.parquet:598012..2280549, /testdata/tpch/data/lineitem/14.parquet:0..720759], ...]}, projection=[l_orderkey, l_suppkey, l_commitdate, l_receiptdate], file_type=parquet, predicate=l_receiptdate@3 > l_commitdate@2
                └──────────────────────────────────────────────────
    ...
    async fn test_tpch_22() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
            │ RepartitionExec: partitioning=Hash([cntrycode@0], 30), input_partitions=15
            ...
            │             CoalescePartitionsExec
            │               NetworkCoalesceTasksExec read_from=Stage 2, output_partitions=30, input_tasks=2
            │             DataSourceExec: file_groups={15 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..54024], [/testdata/tpch/data/orders/10.parquet:54024..817463, /testdata/tpch/data/orders/11.parquet:0..108855], [/testdata/tpch/data/orders/11.parquet:108855..816070, /testdata/tpch/data/orders/12.parquet:0..165079], [/testdata/tpch/data/orders/12.parquet:165079..820827, /testdata/tpch/data/orders/13.parquet:0..216546], [/testdata/tpch/data/orders/13.parquet:216546..821995, /testdata/tpch/data/orders/14.parquet:0..266845], ...]}, projection=[o_custkey], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14] t1:[p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29] 
    ...
    async fn build_state(
        ...
        let rule = DistributedPhysicalOptimizerRule::new()
            ...
            .with_coalesce_partitions_exec_tasks(2);
    ...
    async fn run_tpch_query(ctx_d: SessionContext, query_id: u8) -> Result<String, Box<dyn Error>> {
        ...
        let config_s = SessionConfig::new().with_target_partitions(15);
    ...
    // test_non_distributed_consistency runs each TPC-H query twice - once in a distributed manner
    // and once in a non-distributed manner. For each query, it asserts that the results are identical.
    async fn plan_tpch_query(query_id: u8) -> Result<String, Box<dyn Error>> {
        ensure_tpch_data(0.1, 16).await;
        let (ctx2, _guard) = start_localhost_context(2, build_state).await;
        let sql = get_test_tpch_query(query_id);
        ctx2.state_ref()
            .write()
            .config_mut()
        ...
        let plan2 = if query_id == 15 {
            ...
            df2.create_physical_plan().await?
        } else {
