...
mod tests {
    ...
    async fn test_tpch_1() -> Result<(), Box<dyn Error>> {
        ...
        │           ArrowFlightReadExec input_stage=1, input_partitions=3, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1] t1:[p2] 
          │ RepartitionExec: partitioning=Hash([l_returnflag@0, l_linestatus@1], 3), input_partitions=2
          ...
          │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_quantity, l_extendedprice, l_discount, l_tax, l_returnflag, l_linestatus, l_shipdate], file_type=parquet, predicate=l_shipdate@6 <= 1998-09-02, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@0 <= 1998-09-02, required_guarantees=[]
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_2() -> Result<(), Box<dyn Error>> {
        ...
        │                       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/region/1.parquet], [/testdata/tpch/data/region/2.parquet], [/testdata/tpch/data/region/3.parquet]]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = EUROPE, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= EUROPE AND EUROPE <= r_name_max@1, required_guarantees=[r_name in (EUROPE)]
        ...
        │                       CoalescePartitionsExec
        │                         DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet], [/testdata/tpch/data/nation/2.parquet], [/testdata/tpch/data/nation/3.parquet]]}, projection=[n_nationkey, n_name, n_regionkey], file_type=parquet
        ...
        │                             CoalescePartitionsExec
        │                               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet], [/testdata/tpch/data/supplier/2.parquet], [/testdata/tpch/data/supplier/3.parquet]]}, projection=[s_suppkey, s_name, s_address, s_nationkey, s_phone, s_acctbal, s_comment], file_type=parquet
        │                             CoalesceBatchesExec: target_batch_size=8192
        ...
        │                                       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet], [/testdata/tpch/data/part/2.parquet], [/testdata/tpch/data/part/3.parquet]]}, projection=[p_partkey, p_mfgr, p_type, p_size], file_type=parquet, predicate=p_size@3 = 15 AND p_type@2 LIKE %BRASS, pruning_predicate=p_size_null_count@2 != row_count@3 AND p_size_min@0 <= 15 AND 15 <= p_size_max@1, required_guarantees=[p_size in (15)]
        │                                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet], [/testdata/tpch/data/partsupp/2.parquet], [/testdata/tpch/data/partsupp/3.parquet]]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
        ...
        │               CoalesceBatchesExec: target_batch_size=8192
        │                 ArrowFlightReadExec input_stage=1, input_partitions=3, input_tasks=1
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([ps_partkey@0], 3), input_partitions=3
          ...
          │               CoalescePartitionsExec
          │                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet], [/testdata/tpch/data/nation/2.parquet], [/testdata/tpch/data/nation/3.parquet]]}, projection=[n_nationkey, n_regionkey], file_type=parquet
          ...
          │                     CoalescePartitionsExec
          │                       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet], [/testdata/tpch/data/supplier/2.parquet], [/testdata/tpch/data/supplier/3.parquet]]}, projection=[s_suppkey, s_nationkey], file_type=parquet
          │                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet], [/testdata/tpch/data/partsupp/2.parquet], [/testdata/tpch/data/partsupp/3.parquet]]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
          └──────────────────────────────────────────────────
        ");
        Ok(())
    ...
    async fn test_tpch_3() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([l_orderkey@0, o_orderdate@1, o_shippriority@2], 3), input_partitions=3
          ...
          │                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet], [/testdata/tpch/data/customer/2.parquet], [/testdata/tpch/data/customer/3.parquet]]}, projection=[c_custkey, c_mktsegment], file_type=parquet, predicate=c_mktsegment@1 = BUILDING, pruning_predicate=c_mktsegment_null_count@2 != row_count@3 AND c_mktsegment_min@0 <= BUILDING AND BUILDING <= c_mktsegment_max@1, required_guarantees=[c_mktsegment in (BUILDING)]
          │               CoalesceBatchesExec: target_batch_size=8192
          │                 FilterExec: o_orderdate@2 < 1995-03-15
          │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet], [/testdata/tpch/data/orders/2.parquet], [/testdata/tpch/data/orders/3.parquet]]}, projection=[o_orderkey, o_custkey, o_orderdate, o_shippriority], file_type=parquet, predicate=o_orderdate@2 < 1995-03-15, pruning_predicate=o_orderdate_null_count@1 != row_count@2 AND o_orderdate_min@0 < 1995-03-15, required_guarantees=[]
          │         CoalesceBatchesExec: target_batch_size=8192
          │           FilterExec: l_shipdate@3 > 1995-03-15, projection=[l_orderkey@0, l_extendedprice@1, l_discount@2]
          │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@3 > 1995-03-15, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 > 1995-03-15, required_guarantees=[]
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_4() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_commitdate, l_receiptdate], file_type=parquet, predicate=l_receiptdate@2 > l_commitdate@1
          │         CoalesceBatchesExec: target_batch_size=8192
          │           FilterExec: o_orderdate@1 >= 1993-07-01 AND o_orderdate@1 < 1993-10-01, projection=[o_orderkey@0, o_orderpriority@2]
          │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet], [/testdata/tpch/data/orders/2.parquet], [/testdata/tpch/data/orders/3.parquet]]}, projection=[o_orderkey, o_orderdate, o_orderpriority], file_type=parquet, predicate=o_orderdate@1 >= 1993-07-01 AND o_orderdate@1 < 1993-10-01, pruning_predicate=o_orderdate_null_count@1 != row_count@2 AND o_orderdate_max@0 >= 1993-07-01 AND o_orderdate_null_count@1 != row_count@2 AND o_orderdate_min@3 < 1993-10-01, required_guarantees=[]
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_5() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([n_name@0], 3), input_partitions=3
          ...
          │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/region/1.parquet], [/testdata/tpch/data/region/2.parquet], [/testdata/tpch/data/region/3.parquet]]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = ASIA, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= ASIA AND ASIA <= r_name_max@1, required_guarantees=[r_name in (ASIA)]
          │         CoalesceBatchesExec: target_batch_size=8192
          │           HashJoinExec: mode=CollectLeft, join_type=Inner, on=[(s_nationkey@2, n_nationkey@0)], projection=[l_extendedprice@0, l_discount@1, n_name@4, n_regionkey@5]
          │             CoalescePartitionsExec
          ...
          │                                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet], [/testdata/tpch/data/customer/2.parquet], [/testdata/tpch/data/customer/3.parquet]]}, projection=[c_custkey, c_nationkey], file_type=parquet
          │                         DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet
          │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet], [/testdata/tpch/data/nation/2.parquet], [/testdata/tpch/data/nation/3.parquet]]}, projection=[n_nationkey, n_name, n_regionkey], file_type=parquet
          └──────────────────────────────────────────────────
        ");
        Ok(())
    ...
    async fn test_tpch_7() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([supp_nation@0, cust_nation@1, l_year@2], 3), input_partitions=3
          ...
          │                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet], [/testdata/tpch/data/nation/2.parquet], [/testdata/tpch/data/nation/3.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = GERMANY OR n_name@1 = FRANCE, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= GERMANY AND GERMANY <= n_name_max@1 OR n_name_null_count@2 != row_count@3 AND n_name_min@0 <= FRANCE AND FRANCE <= n_name_max@1, required_guarantees=[n_name in (FRANCE, GERMANY)]
          ...
          │                       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet], [/testdata/tpch/data/nation/2.parquet], [/testdata/tpch/data/nation/3.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = FRANCE OR n_name@1 = GERMANY, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= FRANCE AND FRANCE <= n_name_max@1 OR n_name_null_count@2 != row_count@3 AND n_name_min@0 <= GERMANY AND GERMANY <= n_name_max@1, required_guarantees=[n_name in (FRANCE, GERMANY)]
          ...
          │                                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_suppkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@4 >= 1995-01-01 AND l_shipdate@4 <= 1996-12-31, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1995-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 <= 1996-12-31, required_guarantees=[]
          │                           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet], [/testdata/tpch/data/orders/2.parquet], [/testdata/tpch/data/orders/3.parquet]]}, projection=[o_orderkey, o_custkey], file_type=parquet
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_8() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([o_year@0], 3), input_partitions=3
          ...
          │                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/region/1.parquet], [/testdata/tpch/data/region/2.parquet], [/testdata/tpch/data/region/3.parquet]]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = AMERICA, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= AMERICA AND AMERICA <= r_name_max@1, required_guarantees=[r_name in (AMERICA)]
          ...
          │                 CoalescePartitionsExec
          │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet], [/testdata/tpch/data/nation/2.parquet], [/testdata/tpch/data/nation/3.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet
          ...
          │                                                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet], [/testdata/tpch/data/part/2.parquet], [/testdata/tpch/data/part/3.parquet]]}, projection=[p_partkey, p_type], file_type=parquet, predicate=p_type@1 = ECONOMY ANODIZED STEEL, pruning_predicate=p_type_null_count@2 != row_count@3 AND p_type_min@0 <= ECONOMY ANODIZED STEEL AND ECONOMY ANODIZED STEEL <= p_type_max@1, required_guarantees=[p_type in (ECONOMY ANODIZED STEEL)]
          │                                             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_partkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet
          │                           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet], [/testdata/tpch/data/customer/2.parquet], [/testdata/tpch/data/customer/3.parquet]]}, projection=[c_custkey, c_nationkey], file_type=parquet
          └──────────────────────────────────────────────────
        "#);
        Ok(())
    ...
    async fn test_tpch_9() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([nation@0, o_year@1], 3), input_partitions=3
          ...
          │                 CoalescePartitionsExec
          │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet], [/testdata/tpch/data/orders/2.parquet], [/testdata/tpch/data/orders/3.parquet]]}, projection=[o_orderkey, o_orderdate], file_type=parquet
          │                 CoalesceBatchesExec: target_batch_size=8192
          │                   HashJoinExec: mode=CollectLeft, join_type=Inner, on=[(l_suppkey@2, ps_suppkey@1), (l_partkey@1, ps_partkey@0)], projection=[l_orderkey@0, l_quantity@3, l_extendedprice@4, l_discount@5, s_nationkey@6, ps_supplycost@9]
          │                     CoalescePartitionsExec
          ...
          │                                       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet], [/testdata/tpch/data/part/2.parquet], [/testdata/tpch/data/part/3.parquet]]}, projection=[p_partkey, p_name], file_type=parquet, predicate=p_name@1 LIKE %green%
          │                                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_partkey, l_suppkey, l_quantity, l_extendedprice, l_discount], file_type=parquet
          │                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet], [/testdata/tpch/data/partsupp/2.parquet], [/testdata/tpch/data/partsupp/3.parquet]]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
          └──────────────────────────────────────────────────
        ");
        Ok(())
    ...
    async fn test_tpch_10() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([c_custkey@0, c_name@1, c_acctbal@2, c_phone@3, n_name@4, c_address@5, c_comment@6], 3), input_partitions=3
          ...
          │                       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet], [/testdata/tpch/data/customer/2.parquet], [/testdata/tpch/data/customer/3.parquet]]}, projection=[c_custkey, c_name, c_address, c_nationkey, c_phone, c_acctbal, c_comment], file_type=parquet
          │               CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_11() -> Result<(), Box<dyn Error>> {
        ...
        │                           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet], [/testdata/tpch/data/nation/2.parquet], [/testdata/tpch/data/nation/3.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = GERMANY, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= GERMANY AND GERMANY <= n_name_max@1, required_guarantees=[n_name in (GERMANY)]
        ...
        │                           CoalescePartitionsExec
        │                             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet], [/testdata/tpch/data/supplier/2.parquet], [/testdata/tpch/data/supplier/3.parquet]]}, projection=[s_suppkey, s_nationkey], file_type=parquet
        │                           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet], [/testdata/tpch/data/partsupp/2.parquet], [/testdata/tpch/data/partsupp/3.parquet]]}, projection=[ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet
        ...
        └──────────────────────────────────────────────────
          ...
          │               CoalescePartitionsExec
          │                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet], [/testdata/tpch/data/supplier/2.parquet], [/testdata/tpch/data/supplier/3.parquet]]}, projection=[s_suppkey, s_nationkey], file_type=parquet
          │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet], [/testdata/tpch/data/partsupp/2.parquet], [/testdata/tpch/data/partsupp/3.parquet]]}, projection=[ps_partkey, ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_12() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([l_shipmode@0], 3), input_partitions=3
          ...
          │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_shipdate, l_commitdate, l_receiptdate, l_shipmode], file_type=parquet, predicate=(l_shipmode@4 = MAIL OR l_shipmode@4 = SHIP) AND l_receiptdate@3 > l_commitdate@2 AND l_shipdate@1 < l_commitdate@2 AND l_receiptdate@3 >= 1994-01-01 AND l_receiptdate@3 < 1995-01-01, pruning_predicate=(l_shipmode_null_count@2 != row_count@3 AND l_shipmode_min@0 <= MAIL AND MAIL <= l_shipmode_max@1 OR l_shipmode_null_count@2 != row_count@3 AND l_shipmode_min@0 <= SHIP AND SHIP <= l_shipmode_max@1) AND l_receiptdate_null_count@5 != row_count@3 AND l_receiptdate_max@4 >= 1994-01-01 AND l_receiptdate_null_count@5 != row_count@3 AND l_receiptdate_min@6 < 1995-01-01, required_guarantees=[l_shipmode in (MAIL, SHIP)]
          │         DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet], [/testdata/tpch/data/orders/2.parquet], [/testdata/tpch/data/orders/3.parquet]]}, projection=[o_orderkey, o_orderpriority], file_type=parquet
          └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
    ...
    async fn test_tpch_13() -> Result<(), Box<dyn Error>> {
        ...
        │         CoalesceBatchesExec: target_batch_size=8192
        │           ArrowFlightReadExec input_stage=2, input_partitions=3, input_tasks=1
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet], [/testdata/tpch/data/orders/2.parquet], [/testdata/tpch/data/orders/3.parquet]]}, projection=[o_orderkey, o_custkey, o_comment], file_type=parquet, predicate=o_comment@2 NOT LIKE %special%requests%
            │           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet], [/testdata/tpch/data/customer/2.parquet], [/testdata/tpch/data/customer/3.parquet]]}, projection=[c_custkey], file_type=parquet
            └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_14() -> Result<(), Box<dyn Error>> {
        ...
        │               CoalescePartitionsExec
        │                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet], [/testdata/tpch/data/part/2.parquet], [/testdata/tpch/data/part/3.parquet]]}, projection=[p_partkey, p_type], file_type=parquet
        │               CoalesceBatchesExec: target_batch_size=8192
        │                 FilterExec: l_shipdate@3 >= 1995-09-01 AND l_shipdate@3 < 1995-10-01, projection=[l_partkey@0, l_extendedprice@1, l_discount@2]
        │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_partkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@3 >= 1995-09-01 AND l_shipdate@3 < 1995-10-01, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1995-09-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1995-10-01, required_guarantees=[]
        └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
    ...
    async fn test_tpch_15() -> Result<(), Box<dyn Error>> {
        ...
        │             CoalescePartitionsExec
        │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet], [/testdata/tpch/data/supplier/2.parquet], [/testdata/tpch/data/supplier/3.parquet]]}, projection=[s_suppkey, s_name, s_address, s_phone], file_type=parquet
        ...
        │               AggregateExec: mode=FinalPartitioned, gby=[l_suppkey@0 as l_suppkey], aggr=[sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)]
        │                 CoalesceBatchesExec: target_batch_size=8192
        │                   ArrowFlightReadExec input_stage=2, input_partitions=3, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1] t1:[p2] 
          │ RepartitionExec: partitioning=Hash([l_suppkey@0], 3), input_partitions=2
          │   PartitionIsolatorExec Tasks: t0:[p0,p1,__] t1:[__,__,p0] 
          ...
          │           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_suppkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@3 >= 1996-01-01 AND l_shipdate@3 < 1996-04-01, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1996-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1996-04-01, required_guarantees=[]
          └──────────────────────────────────────────────────
          ┌───── Stage 2   Tasks: t0:[p0,p1] t1:[p2] 
          │ RepartitionExec: partitioning=Hash([l_suppkey@0], 3), input_partitions=2
          │   PartitionIsolatorExec Tasks: t0:[p0,p1,__] t1:[__,__,p0] 
          │     AggregateExec: mode=Partial, gby=[l_suppkey@0 as l_suppkey], aggr=[sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)]
          │       CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_16() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 2   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2], 3), input_partitions=3
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 1   Tasks: t0:[p0,p1,p2] 
            │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2, alias1@3], 3), input_partitions=3
            ...
            │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet], [/testdata/tpch/data/supplier/2.parquet], [/testdata/tpch/data/supplier/3.parquet]]}, projection=[s_suppkey, s_comment], file_type=parquet, predicate=s_comment@1 LIKE %Customer%Complaints%
    ...
    async fn test_tpch_17() -> Result<(), Box<dyn Error>> {
        ...
        │                           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet], [/testdata/tpch/data/part/2.parquet], [/testdata/tpch/data/part/3.parquet]]}, projection=[p_partkey, p_brand, p_container], file_type=parquet, predicate=p_brand@1 = Brand#23 AND p_container@2 = MED BOX, pruning_predicate=p_brand_null_count@2 != row_count@3 AND p_brand_min@0 <= Brand#23 AND Brand#23 <= p_brand_max@1 AND p_container_null_count@6 != row_count@3 AND p_container_min@4 <= MED BOX AND MED BOX <= p_container_max@5, required_guarantees=[p_brand in (Brand#23), p_container in (MED BOX)]
        │                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_partkey, l_quantity, l_extendedprice], file_type=parquet
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1] t1:[p2] 
          │ RepartitionExec: partitioning=Hash([l_partkey@0], 3), input_partitions=2
          │   PartitionIsolatorExec Tasks: t0:[p0,p1,__] t1:[__,__,p0] 
          │     AggregateExec: mode=Partial, gby=[l_partkey@0 as l_partkey], aggr=[avg(lineitem.l_quantity)]
          │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_partkey, l_quantity], file_type=parquet
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_18() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 2   Tasks: t0:[p0,p1,p2] 
          │ RepartitionExec: partitioning=Hash([c_name@0, c_custkey@1, o_orderkey@2, o_orderdate@3, o_totalprice@4], 3), input_partitions=3
          ...
          │                   CoalescePartitionsExec
          │                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet], [/testdata/tpch/data/customer/2.parquet], [/testdata/tpch/data/customer/3.parquet]]}, projection=[c_custkey, c_name], file_type=parquet
          │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet], [/testdata/tpch/data/orders/2.parquet], [/testdata/tpch/data/orders/3.parquet]]}, projection=[o_orderkey, o_custkey, o_totalprice, o_orderdate], file_type=parquet
          │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_quantity], file_type=parquet
          └──────────────────────────────────────────────────
            ┌───── Stage 1   Tasks: t0:[p0,p1] t1:[p2] 
            │ RepartitionExec: partitioning=Hash([l_orderkey@0], 3), input_partitions=2
            │   PartitionIsolatorExec Tasks: t0:[p0,p1,__] t1:[__,__,p0] 
    ...
    async fn test_tpch_20() -> Result<(), Box<dyn Error>> {
        ...
        │                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet], [/testdata/tpch/data/nation/2.parquet], [/testdata/tpch/data/nation/3.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = CANADA, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= CANADA AND CANADA <= n_name_max@1, required_guarantees=[n_name in (CANADA)]
        │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet], [/testdata/tpch/data/supplier/2.parquet], [/testdata/tpch/data/supplier/3.parquet]]}, projection=[s_suppkey, s_name, s_address, s_nationkey], file_type=parquet
        │         CoalesceBatchesExec: target_batch_size=8192
        ...
        │                         DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet], [/testdata/tpch/data/part/2.parquet], [/testdata/tpch/data/part/3.parquet]]}, projection=[p_partkey, p_name], file_type=parquet, predicate=p_name@1 LIKE forest%, pruning_predicate=p_name_null_count@2 != row_count@3 AND p_name_min@0 <= foresu AND forest <= p_name_max@1, required_guarantees=[]
        │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet], [/testdata/tpch/data/partsupp/2.parquet], [/testdata/tpch/data/partsupp/3.parquet]]}, projection=[ps_partkey, ps_suppkey, ps_availqty], file_type=parquet
        ...
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0,p1] t1:[p2] 
          │ RepartitionExec: partitioning=Hash([l_partkey@0, l_suppkey@1], 3), input_partitions=2
          │   PartitionIsolatorExec Tasks: t0:[p0,p1,__] t1:[__,__,p0] 
          ...
          │           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_partkey, l_suppkey, l_quantity, l_shipdate], file_type=parquet, predicate=l_shipdate@3 >= 1994-01-01 AND l_shipdate@3 < 1995-01-01, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1994-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1995-01-01, required_guarantees=[]
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_21() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │                           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet], [/testdata/tpch/data/nation/2.parquet], [/testdata/tpch/data/nation/3.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = SAUDI ARABIA, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= SAUDI ARABIA AND SAUDI ARABIA <= n_name_max@1, required_guarantees=[n_name in (SAUDI ARABIA)]
          │                     CoalesceBatchesExec: target_batch_size=8192
          ...
          │                               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet], [/testdata/tpch/data/orders/2.parquet], [/testdata/tpch/data/orders/3.parquet]]}, projection=[o_orderkey, o_orderstatus], file_type=parquet, predicate=o_orderstatus@1 = F, pruning_predicate=o_orderstatus_null_count@2 != row_count@3 AND o_orderstatus_min@0 <= F AND F <= o_orderstatus_max@1, required_guarantees=[o_orderstatus in (F)]
          │                         CoalesceBatchesExec: target_batch_size=8192
          ...
          │                             CoalescePartitionsExec
          │                               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet], [/testdata/tpch/data/supplier/2.parquet], [/testdata/tpch/data/supplier/3.parquet]]}, projection=[s_suppkey, s_name, s_nationkey], file_type=parquet
          │                             CoalesceBatchesExec: target_batch_size=8192
          │                               FilterExec: l_receiptdate@3 > l_commitdate@2, projection=[l_orderkey@0, l_suppkey@1]
          │                                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_suppkey, l_commitdate, l_receiptdate], file_type=parquet, predicate=l_receiptdate@3 > l_commitdate@2
          │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_suppkey], file_type=parquet
          │         CoalesceBatchesExec: target_batch_size=8192
          │           FilterExec: l_receiptdate@3 > l_commitdate@2, projection=[l_orderkey@0, l_suppkey@1]
          │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet], [/testdata/tpch/data/lineitem/2.parquet], [/testdata/tpch/data/lineitem/3.parquet]]}, projection=[l_orderkey, l_suppkey, l_commitdate, l_receiptdate], file_type=parquet, predicate=l_receiptdate@3 > l_commitdate@2
          └──────────────────────────────────────────────────
    ...
    async fn test_tpch_22() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet], [/testdata/tpch/data/customer/2.parquet], [/testdata/tpch/data/customer/3.parquet]]}, projection=[c_custkey, c_phone, c_acctbal], file_type=parquet, predicate=substr(c_phone@1, 1, 2) IN ([Literal { value: Utf8View("13"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("31"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("23"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("29"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("30"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("18"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("17"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }])
          │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet], [/testdata/tpch/data/orders/2.parquet], [/testdata/tpch/data/orders/3.parquet]]}, projection=[o_custkey], file_type=parquet
          └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
