...
mod tests {
    ...
    async fn test_tpch_1() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceExec read_from=Stage 2, output_partitions=12, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 2   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
          ...
          │         NetworkShuffleExec read_from=Stage 1, output_partitions=3, n_tasks=4, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
            │ RepartitionExec: partitioning=Hash([l_returnflag@0, l_linestatus@1], 12), input_partitions=1
            ...
            │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_quantity, l_extendedprice, l_discount, l_tax, l_returnflag, l_linestatus, l_shipdate], file_type=parquet, predicate=l_shipdate@6 <= 1998-09-02, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@0 <= 1998-09-02, required_guarantees=[]
            └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_2() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceExec read_from=Stage 7, output_partitions=12, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 7   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
          ...
          │         CoalesceBatchesExec: target_batch_size=8192
          │           NetworkShuffleExec read_from=Stage 3, output_partitions=3, n_tasks=4, input_tasks=1
          │         CoalesceBatchesExec: target_batch_size=8192
          │           NetworkShuffleExec read_from=Stage 6, output_partitions=3, n_tasks=4, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            ...
            │         NetworkCoalesceExec read_from=Stage 1, output_partitions=3, input_tasks=3
            ...
            │             CoalescePartitionsExec
            │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet, /testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet, /testdata/tpch/data/nation/13.parquet, ...], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet, /testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet, /testdata/tpch/data/nation/4.parquet, ...], [/testdata/tpch/data/nation/6.parquet, /testdata/tpch/data/nation/7.parquet, /testdata/tpch/data/nation/8.parquet, /testdata/tpch/data/nation/9.parquet]]}, projection=[n_nationkey, n_name, n_regionkey], file_type=parquet
            ...
            │                   CoalescePartitionsExec
            │                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet, /testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet, /testdata/tpch/data/supplier/13.parquet, ...], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet, /testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet, /testdata/tpch/data/supplier/4.parquet, ...], [/testdata/tpch/data/supplier/6.parquet, /testdata/tpch/data/supplier/7.parquet, /testdata/tpch/data/supplier/8.parquet, /testdata/tpch/data/supplier/9.parquet]]}, projection=[s_suppkey, s_name, s_address, s_nationkey, s_phone, s_acctbal, s_comment], file_type=parquet
            │                   CoalesceBatchesExec: target_batch_size=8192
            ...
            │                       CoalescePartitionsExec
            │                         NetworkCoalesceExec read_from=Stage 2, output_partitions=3, input_tasks=3
            │                       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..748125, /testdata/tpch/data/partsupp/11.parquet:0..744689, /testdata/tpch/data/partsupp/12.parquet:0..749068, /testdata/tpch/data/partsupp/13.parquet:0..750296, ...], [/testdata/tpch/data/partsupp/14.parquet:251447..748674, /testdata/tpch/data/partsupp/15.parquet:0..744298, /testdata/tpch/data/partsupp/16.parquet:0..748035, /testdata/tpch/data/partsupp/2.parquet:0..753010, /testdata/tpch/data/partsupp/3.parquet:0..756405, ...], [/testdata/tpch/data/partsupp/4.parquet:498158..746724, /testdata/tpch/data/partsupp/5.parquet:0..746720, /testdata/tpch/data/partsupp/6.parquet:0..750184, /testdata/tpch/data/partsupp/7.parquet:0..748095, /testdata/tpch/data/partsupp/8.parquet:0..750205, ...]]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: r_name@1 = EUROPE, projection=[r_regionkey@0]
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/region/1.parquet, /testdata/tpch/data/region/10.parquet, /testdata/tpch/data/region/11.parquet, /testdata/tpch/data/region/12.parquet, /testdata/tpch/data/region/13.parquet, ...], [/testdata/tpch/data/region/15.parquet, /testdata/tpch/data/region/16.parquet, /testdata/tpch/data/region/2.parquet, /testdata/tpch/data/region/3.parquet, /testdata/tpch/data/region/4.parquet, ...], [/testdata/tpch/data/region/6.parquet, /testdata/tpch/data/region/7.parquet, /testdata/tpch/data/region/8.parquet, /testdata/tpch/data/region/9.parquet]]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = EUROPE, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= EUROPE AND EUROPE <= r_name_max@1, required_guarantees=[r_name in (EUROPE)]
              └──────────────────────────────────────────────────
              ┌───── Stage 2   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: p_size@3 = 15 AND p_type@2 LIKE %BRASS, projection=[p_partkey@0, p_mfgr@1]
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet, /testdata/tpch/data/part/10.parquet, /testdata/tpch/data/part/11.parquet, /testdata/tpch/data/part/12.parquet, /testdata/tpch/data/part/13.parquet, ...], [/testdata/tpch/data/part/15.parquet, /testdata/tpch/data/part/16.parquet, /testdata/tpch/data/part/2.parquet, /testdata/tpch/data/part/3.parquet, /testdata/tpch/data/part/4.parquet, ...], [/testdata/tpch/data/part/6.parquet, /testdata/tpch/data/part/7.parquet, /testdata/tpch/data/part/8.parquet, /testdata/tpch/data/part/9.parquet]]}, projection=[p_partkey, p_mfgr, p_type, p_size], file_type=parquet, predicate=p_size@3 = 15 AND p_type@2 LIKE %BRASS, pruning_predicate=p_size_null_count@2 != row_count@3 AND p_size_min@0 <= 15 AND 15 <= p_size_max@1, required_guarantees=[p_size in (15)]
              └──────────────────────────────────────────────────
            ┌───── Stage 6   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] t3:[p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47] 
            ...
            │       CoalesceBatchesExec: target_batch_size=8192
            │         NetworkShuffleExec read_from=Stage 5, output_partitions=3, n_tasks=4, input_tasks=1
            └──────────────────────────────────────────────────
              ┌───── Stage 5   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
              │ RepartitionExec: partitioning=Hash([ps_partkey@0], 12), input_partitions=3
              ...
              │         CoalescePartitionsExec
              │           NetworkCoalesceExec read_from=Stage 4, output_partitions=3, input_tasks=3
              ...
              │               CoalescePartitionsExec
              │                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet, /testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet, /testdata/tpch/data/nation/13.parquet, ...], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet, /testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet, /testdata/tpch/data/nation/4.parquet, ...], [/testdata/tpch/data/nation/6.parquet, /testdata/tpch/data/nation/7.parquet, /testdata/tpch/data/nation/8.parquet, /testdata/tpch/data/nation/9.parquet]]}, projection=[n_nationkey, n_regionkey], file_type=parquet
              ...
              │                     CoalescePartitionsExec
              │                       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet, /testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet, /testdata/tpch/data/supplier/13.parquet, ...], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet, /testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet, /testdata/tpch/data/supplier/4.parquet, ...], [/testdata/tpch/data/supplier/6.parquet, /testdata/tpch/data/supplier/7.parquet, /testdata/tpch/data/supplier/8.parquet, /testdata/tpch/data/supplier/9.parquet]]}, projection=[s_suppkey, s_nationkey], file_type=parquet
              │                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..748125, /testdata/tpch/data/partsupp/11.parquet:0..744689, /testdata/tpch/data/partsupp/12.parquet:0..749068, /testdata/tpch/data/partsupp/13.parquet:0..750296, ...], [/testdata/tpch/data/partsupp/14.parquet:251447..748674, /testdata/tpch/data/partsupp/15.parquet:0..744298, /testdata/tpch/data/partsupp/16.parquet:0..748035, /testdata/tpch/data/partsupp/2.parquet:0..753010, /testdata/tpch/data/partsupp/3.parquet:0..756405, ...], [/testdata/tpch/data/partsupp/4.parquet:498158..746724, /testdata/tpch/data/partsupp/5.parquet:0..746720, /testdata/tpch/data/partsupp/6.parquet:0..750184, /testdata/tpch/data/partsupp/7.parquet:0..748095, /testdata/tpch/data/partsupp/8.parquet:0..750205, ...]]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
              └──────────────────────────────────────────────────
    ...
    async fn test_tpch_3() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceExec read_from=Stage 3, output_partitions=12, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 3   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkShuffleExec read_from=Stage 2, output_partitions=3, n_tasks=4, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([l_orderkey@0, o_orderdate@1, o_shippriority@2], 12), input_partitions=3
            ...
            │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..817463, /testdata/tpch/data/orders/11.parquet:0..816070, /testdata/tpch/data/orders/12.parquet:0..820827, /testdata/tpch/data/orders/13.parquet:0..821995, ...], [/testdata/tpch/data/orders/14.parquet:266845..815509, /testdata/tpch/data/orders/15.parquet:0..815233, /testdata/tpch/data/orders/16.parquet:0..817706, /testdata/tpch/data/orders/2.parquet:0..817737, /testdata/tpch/data/orders/3.parquet:0..817566, ...], [/testdata/tpch/data/orders/4.parquet:544564..821332, /testdata/tpch/data/orders/5.parquet:0..815888, /testdata/tpch/data/orders/6.parquet:0..815311, /testdata/tpch/data/orders/7.parquet:0..820001, /testdata/tpch/data/orders/8.parquet:0..817309, ...]]}, projection=[o_orderkey, o_custkey, o_orderdate, o_shippriority], file_type=parquet, predicate=o_orderdate@2 < 1995-03-15, pruning_predicate=o_orderdate_null_count@1 != row_count@2 AND o_orderdate_min@0 < 1995-03-15, required_guarantees=[]
            │         CoalesceBatchesExec: target_batch_size=8192
            │           FilterExec: l_shipdate@3 > 1995-03-15, projection=[l_orderkey@0, l_extendedprice@1, l_discount@2]
            │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@3 > 1995-03-15, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 > 1995-03-15, required_guarantees=[]
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: c_mktsegment@1 = BUILDING, projection=[c_custkey@0]
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet, /testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet, /testdata/tpch/data/customer/13.parquet, ...], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet, /testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet, /testdata/tpch/data/customer/4.parquet, ...], [/testdata/tpch/data/customer/6.parquet, /testdata/tpch/data/customer/7.parquet, /testdata/tpch/data/customer/8.parquet, /testdata/tpch/data/customer/9.parquet]]}, projection=[c_custkey, c_mktsegment], file_type=parquet, predicate=c_mktsegment@1 = BUILDING, pruning_predicate=c_mktsegment_null_count@2 != row_count@3 AND c_mktsegment_min@0 <= BUILDING AND BUILDING <= c_mktsegment_max@1, required_guarantees=[c_mktsegment in (BUILDING)]
              └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_4() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([o_orderpriority@0], 12), input_partitions=3
    ...
    async fn test_tpch_5() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceExec read_from=Stage 4, output_partitions=12, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 4   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([n_name@0], 12), input_partitions=3
            ...
            │                                 CoalescePartitionsExec
            │                                   NetworkCoalesceExec read_from=Stage 2, output_partitions=3, input_tasks=3
            │                                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet, /testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet, /testdata/tpch/data/customer/13.parquet, ...], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet, /testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet, /testdata/tpch/data/customer/4.parquet, ...], [/testdata/tpch/data/customer/6.parquet, /testdata/tpch/data/customer/7.parquet, /testdata/tpch/data/customer/8.parquet, /testdata/tpch/data/customer/9.parquet]]}, projection=[c_custkey, c_nationkey], file_type=parquet
            │                         DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: r_name@1 = ASIA, projection=[r_regionkey@0]
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/region/1.parquet, /testdata/tpch/data/region/10.parquet, /testdata/tpch/data/region/11.parquet, /testdata/tpch/data/region/12.parquet, /testdata/tpch/data/region/13.parquet, ...], [/testdata/tpch/data/region/15.parquet, /testdata/tpch/data/region/16.parquet, /testdata/tpch/data/region/2.parquet, /testdata/tpch/data/region/3.parquet, /testdata/tpch/data/region/4.parquet, ...], [/testdata/tpch/data/region/6.parquet, /testdata/tpch/data/region/7.parquet, /testdata/tpch/data/region/8.parquet, /testdata/tpch/data/region/9.parquet]]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = ASIA, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= ASIA AND ASIA <= r_name_max@1, required_guarantees=[r_name in (ASIA)]
              └──────────────────────────────────────────────────
              ┌───── Stage 2   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_7() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([supp_nation@0, cust_nation@1, l_year@2], 12), input_partitions=3
            ...
            │                                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_suppkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@4 >= 1995-01-01 AND l_shipdate@4 <= 1996-12-31, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1995-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 <= 1996-12-31, required_guarantees=[]
            │                           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..817463, /testdata/tpch/data/orders/11.parquet:0..816070, /testdata/tpch/data/orders/12.parquet:0..820827, /testdata/tpch/data/orders/13.parquet:0..821995, ...], [/testdata/tpch/data/orders/14.parquet:266845..815509, /testdata/tpch/data/orders/15.parquet:0..815233, /testdata/tpch/data/orders/16.parquet:0..817706, /testdata/tpch/data/orders/2.parquet:0..817737, /testdata/tpch/data/orders/3.parquet:0..817566, ...], [/testdata/tpch/data/orders/4.parquet:544564..821332, /testdata/tpch/data/orders/5.parquet:0..815888, /testdata/tpch/data/orders/6.parquet:0..815311, /testdata/tpch/data/orders/7.parquet:0..820001, /testdata/tpch/data/orders/8.parquet:0..817309, ...]]}, projection=[o_orderkey, o_custkey], file_type=parquet
            │                     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet, /testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet, /testdata/tpch/data/customer/13.parquet, ...], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet, /testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet, /testdata/tpch/data/customer/4.parquet, ...], [/testdata/tpch/data/customer/6.parquet, /testdata/tpch/data/customer/7.parquet, /testdata/tpch/data/customer/8.parquet, /testdata/tpch/data/customer/9.parquet]]}, projection=[c_custkey, c_nationkey], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
              ...
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet, /testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet, /testdata/tpch/data/nation/13.parquet, ...], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet, /testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet, /testdata/tpch/data/nation/4.parquet, ...], [/testdata/tpch/data/nation/6.parquet, /testdata/tpch/data/nation/7.parquet, /testdata/tpch/data/nation/8.parquet, /testdata/tpch/data/nation/9.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = GERMANY OR n_name@1 = FRANCE, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= GERMANY AND GERMANY <= n_name_max@1 OR n_name_null_count@2 != row_count@3 AND n_name_min@0 <= FRANCE AND FRANCE <= n_name_max@1, required_guarantees=[n_name in (FRANCE, GERMANY)]
              └──────────────────────────────────────────────────
              ┌───── Stage 2   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: n_name@1 = FRANCE OR n_name@1 = GERMANY
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet, /testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet, /testdata/tpch/data/nation/13.parquet, ...], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet, /testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet, /testdata/tpch/data/nation/4.parquet, ...], [/testdata/tpch/data/nation/6.parquet, /testdata/tpch/data/nation/7.parquet, /testdata/tpch/data/nation/8.parquet, /testdata/tpch/data/nation/9.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = FRANCE OR n_name@1 = GERMANY, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= FRANCE AND FRANCE <= n_name_max@1 OR n_name_null_count@2 != row_count@3 AND n_name_min@0 <= GERMANY AND GERMANY <= n_name_max@1, required_guarantees=[n_name in (FRANCE, GERMANY)]
              └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_8() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceExec read_from=Stage 8, output_partitions=12, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 8   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkShuffleExec read_from=Stage 7, output_partitions=3, n_tasks=4, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 7   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([o_year@0], 12), input_partitions=3
            ...
            │                 CoalescePartitionsExec
            │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet, /testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet, /testdata/tpch/data/nation/13.parquet, ...], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet, /testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet, /testdata/tpch/data/nation/4.parquet, ...], [/testdata/tpch/data/nation/6.parquet, /testdata/tpch/data/nation/7.parquet, /testdata/tpch/data/nation/8.parquet, /testdata/tpch/data/nation/9.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet
            ...
            │                           CoalesceBatchesExec: target_batch_size=8192
            │                             NetworkShuffleExec read_from=Stage 5, output_partitions=3, n_tasks=1, input_tasks=4
            │                           CoalesceBatchesExec: target_batch_size=8192
            │                             NetworkShuffleExec read_from=Stage 6, output_partitions=3, n_tasks=1, input_tasks=3
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: r_name@1 = AMERICA, projection=[r_regionkey@0]
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/region/1.parquet, /testdata/tpch/data/region/10.parquet, /testdata/tpch/data/region/11.parquet, /testdata/tpch/data/region/12.parquet, /testdata/tpch/data/region/13.parquet, ...], [/testdata/tpch/data/region/15.parquet, /testdata/tpch/data/region/16.parquet, /testdata/tpch/data/region/2.parquet, /testdata/tpch/data/region/3.parquet, /testdata/tpch/data/region/4.parquet, ...], [/testdata/tpch/data/region/6.parquet, /testdata/tpch/data/region/7.parquet, /testdata/tpch/data/region/8.parquet, /testdata/tpch/data/region/9.parquet]]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = AMERICA, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= AMERICA AND AMERICA <= r_name_max@1, required_guarantees=[r_name in (AMERICA)]
              └──────────────────────────────────────────────────
              ┌───── Stage 5   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
              │ RepartitionExec: partitioning=Hash([o_custkey@3], 3), input_partitions=3
              ...
              │         CoalesceBatchesExec: target_batch_size=8192
              │           NetworkShuffleExec read_from=Stage 2, output_partitions=3, n_tasks=4, input_tasks=3
              │         CoalesceBatchesExec: target_batch_size=8192
              │           NetworkShuffleExec read_from=Stage 4, output_partitions=3, n_tasks=4, input_tasks=1
              └──────────────────────────────────────────────────
                ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
                │ RepartitionExec: partitioning=Hash([o_orderkey@0], 12), input_partitions=1
                │   CoalesceBatchesExec: target_batch_size=8192
                ...
                └──────────────────────────────────────────────────
                ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
                │ RepartitionExec: partitioning=Hash([l_orderkey@0], 12), input_partitions=3
                ...
                │             CoalescePartitionsExec
                │               NetworkCoalesceExec read_from=Stage 3, output_partitions=3, input_tasks=3
                │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_partkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet
                └──────────────────────────────────────────────────
                  ┌───── Stage 3   Tasks: t0:[p0] t1:[p1] t2:[p2] 
                  │ CoalesceBatchesExec: target_batch_size=8192
                  │   FilterExec: p_type@1 = ECONOMY ANODIZED STEEL, projection=[p_partkey@0]
                  │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
                  │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet, /testdata/tpch/data/part/10.parquet, /testdata/tpch/data/part/11.parquet, /testdata/tpch/data/part/12.parquet, /testdata/tpch/data/part/13.parquet, ...], [/testdata/tpch/data/part/15.parquet, /testdata/tpch/data/part/16.parquet, /testdata/tpch/data/part/2.parquet, /testdata/tpch/data/part/3.parquet, /testdata/tpch/data/part/4.parquet, ...], [/testdata/tpch/data/part/6.parquet, /testdata/tpch/data/part/7.parquet, /testdata/tpch/data/part/8.parquet, /testdata/tpch/data/part/9.parquet]]}, projection=[p_partkey, p_type], file_type=parquet, predicate=p_type@1 = ECONOMY ANODIZED STEEL, pruning_predicate=p_type_null_count@2 != row_count@3 AND p_type_min@0 <= ECONOMY ANODIZED STEEL AND ECONOMY ANODIZED STEEL <= p_type_max@1, required_guarantees=[p_type in (ECONOMY ANODIZED STEEL)]
                  └──────────────────────────────────────────────────
              ┌───── Stage 6   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] 
              │ RepartitionExec: partitioning=Hash([c_custkey@0], 3), input_partitions=1
              │   PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet, /testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet, /testdata/tpch/data/customer/13.parquet, ...], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet, /testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet, /testdata/tpch/data/customer/4.parquet, ...], [/testdata/tpch/data/customer/6.parquet, /testdata/tpch/data/customer/7.parquet, /testdata/tpch/data/customer/8.parquet, /testdata/tpch/data/customer/9.parquet]]}, projection=[c_custkey, c_nationkey], file_type=parquet
              └──────────────────────────────────────────────────
        "#);
    ...
    async fn test_tpch_9() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkShuffleExec read_from=Stage 6, output_partitions=3, n_tasks=4, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 6   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([nation@0, o_year@1], 12), input_partitions=3
            ...
            │                 CoalesceBatchesExec: target_batch_size=8192
            │                   NetworkShuffleExec read_from=Stage 1, output_partitions=3, n_tasks=1, input_tasks=3
            │                 CoalesceBatchesExec: target_batch_size=8192
            │                   NetworkShuffleExec read_from=Stage 5, output_partitions=3, n_tasks=1, input_tasks=4
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] 
              │ RepartitionExec: partitioning=Hash([o_orderkey@0], 3), input_partitions=1
              │   PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..817463, /testdata/tpch/data/orders/11.parquet:0..816070, /testdata/tpch/data/orders/12.parquet:0..820827, /testdata/tpch/data/orders/13.parquet:0..821995, ...], [/testdata/tpch/data/orders/14.parquet:266845..815509, /testdata/tpch/data/orders/15.parquet:0..815233, /testdata/tpch/data/orders/16.parquet:0..817706, /testdata/tpch/data/orders/2.parquet:0..817737, /testdata/tpch/data/orders/3.parquet:0..817566, ...], [/testdata/tpch/data/orders/4.parquet:544564..821332, /testdata/tpch/data/orders/5.parquet:0..815888, /testdata/tpch/data/orders/6.parquet:0..815311, /testdata/tpch/data/orders/7.parquet:0..820001, /testdata/tpch/data/orders/8.parquet:0..817309, ...]]}, projection=[o_orderkey, o_orderdate], file_type=parquet
              └──────────────────────────────────────────────────
              ┌───── Stage 5   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
              ...
              │         NetworkShuffleExec read_from=Stage 3, output_partitions=3, n_tasks=4, input_tasks=1
              │       CoalesceBatchesExec: target_batch_size=8192
              │         NetworkShuffleExec read_from=Stage 4, output_partitions=3, n_tasks=4, input_tasks=3
              └──────────────────────────────────────────────────
                ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
                │ RepartitionExec: partitioning=Hash([l_suppkey@2, l_partkey@1], 12), input_partitions=3
                ...
                │             CoalescePartitionsExec
                │               NetworkCoalesceExec read_from=Stage 2, output_partitions=3, input_tasks=3
                │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_partkey, l_suppkey, l_quantity, l_extendedprice, l_discount], file_type=parquet
                └──────────────────────────────────────────────────
                  ┌───── Stage 2   Tasks: t0:[p0] t1:[p1] t2:[p2] 
                  │ CoalesceBatchesExec: target_batch_size=8192
                  │   FilterExec: p_name@1 LIKE %green%, projection=[p_partkey@0]
                  │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
                  │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet, /testdata/tpch/data/part/10.parquet, /testdata/tpch/data/part/11.parquet, /testdata/tpch/data/part/12.parquet, /testdata/tpch/data/part/13.parquet, ...], [/testdata/tpch/data/part/15.parquet, /testdata/tpch/data/part/16.parquet, /testdata/tpch/data/part/2.parquet, /testdata/tpch/data/part/3.parquet, /testdata/tpch/data/part/4.parquet, ...], [/testdata/tpch/data/part/6.parquet, /testdata/tpch/data/part/7.parquet, /testdata/tpch/data/part/8.parquet, /testdata/tpch/data/part/9.parquet]]}, projection=[p_partkey, p_name], file_type=parquet, predicate=p_name@1 LIKE %green%
                  └──────────────────────────────────────────────────
                ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
                │ RepartitionExec: partitioning=Hash([ps_suppkey@1, ps_partkey@0], 12), input_partitions=1
                │   PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
                │     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..748125, /testdata/tpch/data/partsupp/11.parquet:0..744689, /testdata/tpch/data/partsupp/12.parquet:0..749068, /testdata/tpch/data/partsupp/13.parquet:0..750296, ...], [/testdata/tpch/data/partsupp/14.parquet:251447..748674, /testdata/tpch/data/partsupp/15.parquet:0..744298, /testdata/tpch/data/partsupp/16.parquet:0..748035, /testdata/tpch/data/partsupp/2.parquet:0..753010, /testdata/tpch/data/partsupp/3.parquet:0..756405, ...], [/testdata/tpch/data/partsupp/4.parquet:498158..746724, /testdata/tpch/data/partsupp/5.parquet:0..746720, /testdata/tpch/data/partsupp/6.parquet:0..750184, /testdata/tpch/data/partsupp/7.parquet:0..748095, /testdata/tpch/data/partsupp/8.parquet:0..750205, ...]]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
                └──────────────────────────────────────────────────
        ");
    ...
    async fn test_tpch_10() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([c_custkey@0, c_name@1, c_acctbal@2, c_phone@3, n_name@4, c_address@5, c_comment@6], 12), input_partitions=3
            ...
            │                       CoalescePartitionsExec
            │                         NetworkCoalesceExec read_from=Stage 1, output_partitions=3, input_tasks=3
            │                       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet, /testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet, /testdata/tpch/data/customer/13.parquet, ...], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet, /testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet, /testdata/tpch/data/customer/4.parquet, ...], [/testdata/tpch/data/customer/6.parquet, /testdata/tpch/data/customer/7.parquet, /testdata/tpch/data/customer/8.parquet, /testdata/tpch/data/customer/9.parquet]]}, projection=[c_custkey, c_name, c_address, c_nationkey, c_phone, c_acctbal, c_comment], file_type=parquet
            │               CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_11() -> Result<(), Box<dyn Error>> {
        ...
        │                           CoalescePartitionsExec
        │                             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet, /testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet, /testdata/tpch/data/supplier/13.parquet, ...], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet, /testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet, /testdata/tpch/data/supplier/4.parquet, ...], [/testdata/tpch/data/supplier/6.parquet, /testdata/tpch/data/supplier/7.parquet, /testdata/tpch/data/supplier/8.parquet, /testdata/tpch/data/supplier/9.parquet]]}, projection=[s_suppkey, s_nationkey], file_type=parquet
        │                           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..748125, /testdata/tpch/data/partsupp/11.parquet:0..744689, /testdata/tpch/data/partsupp/12.parquet:0..749068, /testdata/tpch/data/partsupp/13.parquet:0..750296, ...], [/testdata/tpch/data/partsupp/14.parquet:251447..748674, /testdata/tpch/data/partsupp/15.parquet:0..744298, /testdata/tpch/data/partsupp/16.parquet:0..748035, /testdata/tpch/data/partsupp/2.parquet:0..753010, /testdata/tpch/data/partsupp/3.parquet:0..756405, ...], [/testdata/tpch/data/partsupp/4.parquet:498158..746724, /testdata/tpch/data/partsupp/5.parquet:0..746720, /testdata/tpch/data/partsupp/6.parquet:0..750184, /testdata/tpch/data/partsupp/7.parquet:0..748095, /testdata/tpch/data/partsupp/8.parquet:0..750205, ...]]}, projection=[ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet
        ...
        │                         CoalescePartitionsExec
        │                           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet, /testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet, /testdata/tpch/data/supplier/13.parquet, ...], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet, /testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet, /testdata/tpch/data/supplier/4.parquet, ...], [/testdata/tpch/data/supplier/6.parquet, /testdata/tpch/data/supplier/7.parquet, /testdata/tpch/data/supplier/8.parquet, /testdata/tpch/data/supplier/9.parquet]]}, projection=[s_suppkey, s_nationkey], file_type=parquet
        │                         DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..748125, /testdata/tpch/data/partsupp/11.parquet:0..744689, /testdata/tpch/data/partsupp/12.parquet:0..749068, /testdata/tpch/data/partsupp/13.parquet:0..750296, ...], [/testdata/tpch/data/partsupp/14.parquet:251447..748674, /testdata/tpch/data/partsupp/15.parquet:0..744298, /testdata/tpch/data/partsupp/16.parquet:0..748035, /testdata/tpch/data/partsupp/2.parquet:0..753010, /testdata/tpch/data/partsupp/3.parquet:0..756405, ...], [/testdata/tpch/data/partsupp/4.parquet:498158..746724, /testdata/tpch/data/partsupp/5.parquet:0..746720, /testdata/tpch/data/partsupp/6.parquet:0..750184, /testdata/tpch/data/partsupp/7.parquet:0..748095, /testdata/tpch/data/partsupp/8.parquet:0..750205, ...]]}, projection=[ps_partkey, ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet
        └──────────────────────────────────────────────────
          ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   FilterExec: n_name@1 = GERMANY, projection=[n_nationkey@0]
          │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
          │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet, /testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet, /testdata/tpch/data/nation/13.parquet, ...], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet, /testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet, /testdata/tpch/data/nation/4.parquet, ...], [/testdata/tpch/data/nation/6.parquet, /testdata/tpch/data/nation/7.parquet, /testdata/tpch/data/nation/8.parquet, /testdata/tpch/data/nation/9.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = GERMANY, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= GERMANY AND GERMANY <= n_name_max@1, required_guarantees=[n_name in (GERMANY)]
          └──────────────────────────────────────────────────
          ┌───── Stage 2   Tasks: t0:[p0] t1:[p1] t2:[p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   FilterExec: n_name@1 = GERMANY, projection=[n_nationkey@0]
    ...
    async fn test_tpch_12() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkShuffleExec read_from=Stage 3, output_partitions=3, n_tasks=4, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] t3:[p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47] 
            │ RepartitionExec: partitioning=Hash([l_shipmode@0], 12), input_partitions=3
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
              │ RepartitionExec: partitioning=Hash([l_orderkey@0], 12), input_partitions=1
              │   CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_13() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] t3:[p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47] 
            │ RepartitionExec: partitioning=Hash([c_count@0], 12), input_partitions=3
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
              │ RepartitionExec: partitioning=Hash([c_custkey@0], 12), input_partitions=3
              ...
              │           CoalescePartitionsExec
              │             NetworkCoalesceExec read_from=Stage 1, output_partitions=3, input_tasks=3
              │           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet, /testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet, /testdata/tpch/data/customer/13.parquet, ...], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet, /testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet, /testdata/tpch/data/customer/4.parquet, ...], [/testdata/tpch/data/customer/6.parquet, /testdata/tpch/data/customer/7.parquet, /testdata/tpch/data/customer/8.parquet, /testdata/tpch/data/customer/9.parquet]]}, projection=[c_custkey], file_type=parquet
              └──────────────────────────────────────────────────
                ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
                │ CoalesceBatchesExec: target_batch_size=8192
                │   FilterExec: o_comment@2 NOT LIKE %special%requests%, projection=[o_orderkey@0, o_custkey@1]
                │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
                │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..817463, /testdata/tpch/data/orders/11.parquet:0..816070, /testdata/tpch/data/orders/12.parquet:0..820827, /testdata/tpch/data/orders/13.parquet:0..821995, ...], [/testdata/tpch/data/orders/14.parquet:266845..815509, /testdata/tpch/data/orders/15.parquet:0..815233, /testdata/tpch/data/orders/16.parquet:0..817706, /testdata/tpch/data/orders/2.parquet:0..817737, /testdata/tpch/data/orders/3.parquet:0..817566, ...], [/testdata/tpch/data/orders/4.parquet:544564..821332, /testdata/tpch/data/orders/5.parquet:0..815888, /testdata/tpch/data/orders/6.parquet:0..815311, /testdata/tpch/data/orders/7.parquet:0..820001, /testdata/tpch/data/orders/8.parquet:0..817309, ...]]}, projection=[o_orderkey, o_custkey, o_comment], file_type=parquet, predicate=o_comment@2 NOT LIKE %special%requests%
                └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_14() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
            │ RepartitionExec: partitioning=Hash([p_partkey@0], 12), input_partitions=1
            │   PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
            │     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet, /testdata/tpch/data/part/10.parquet, /testdata/tpch/data/part/11.parquet, /testdata/tpch/data/part/12.parquet, /testdata/tpch/data/part/13.parquet, ...], [/testdata/tpch/data/part/15.parquet, /testdata/tpch/data/part/16.parquet, /testdata/tpch/data/part/2.parquet, /testdata/tpch/data/part/3.parquet, /testdata/tpch/data/part/4.parquet, ...], [/testdata/tpch/data/part/6.parquet, /testdata/tpch/data/part/7.parquet, /testdata/tpch/data/part/8.parquet, /testdata/tpch/data/part/9.parquet]]}, projection=[p_partkey, p_type], file_type=parquet
            └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
            │ RepartitionExec: partitioning=Hash([l_partkey@0], 12), input_partitions=1
            │   CoalesceBatchesExec: target_batch_size=8192
            │     FilterExec: l_shipdate@3 >= 1995-09-01 AND l_shipdate@3 < 1995-10-01, projection=[l_partkey@0, l_extendedprice@1, l_discount@2]
            │       PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
            │         DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_partkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@3 >= 1995-09-01 AND l_shipdate@3 < 1995-10-01, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1995-09-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1995-10-01, required_guarantees=[]
            └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
    ...
    async fn test_tpch_15() -> Result<(), Box<dyn Error>> {
        ...
        │             CoalescePartitionsExec
        │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet, /testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet, /testdata/tpch/data/supplier/13.parquet, ...], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet, /testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet, /testdata/tpch/data/supplier/4.parquet, ...], [/testdata/tpch/data/supplier/6.parquet, /testdata/tpch/data/supplier/7.parquet, /testdata/tpch/data/supplier/8.parquet, /testdata/tpch/data/supplier/9.parquet]]}, projection=[s_suppkey, s_name, s_address, s_phone], file_type=parquet
        ...
        │                 CoalesceBatchesExec: target_batch_size=8192
        │                   NetworkShuffleExec read_from=Stage 3, output_partitions=3, n_tasks=1, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 2   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 1   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
            │ RepartitionExec: partitioning=Hash([l_suppkey@0], 12), input_partitions=1
            ...
            │         PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
            │           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_suppkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@3 >= 1996-01-01 AND l_shipdate@3 < 1996-04-01, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1996-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1996-04-01, required_guarantees=[]
            └──────────────────────────────────────────────────
          ┌───── Stage 3   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] 
          │ RepartitionExec: partitioning=Hash([l_suppkey@0], 3), input_partitions=1
          │   AggregateExec: mode=Partial, gby=[l_suppkey@0 as l_suppkey], aggr=[sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)]
          │     CoalesceBatchesExec: target_batch_size=8192
          │       FilterExec: l_shipdate@3 >= 1996-01-01 AND l_shipdate@3 < 1996-04-01, projection=[l_suppkey@0, l_extendedprice@1, l_discount@2]
          │         PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
    ...
    async fn test_tpch_16() -> Result<(), Box<dyn Error>> {
        ...
        │   NetworkCoalesceExec read_from=Stage 5, output_partitions=12, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 5   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
          ...
          │       CoalesceBatchesExec: target_batch_size=8192
          │         NetworkShuffleExec read_from=Stage 4, output_partitions=3, n_tasks=4, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] t3:[p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47] 
            │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2], 12), input_partitions=3
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
              │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2, alias1@3], 12), input_partitions=3
              ...
              │               CoalescePartitionsExec
              │                 NetworkCoalesceExec read_from=Stage 2, output_partitions=3, input_tasks=3
              │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..748125, /testdata/tpch/data/partsupp/11.parquet:0..744689, /testdata/tpch/data/partsupp/12.parquet:0..749068, /testdata/tpch/data/partsupp/13.parquet:0..750296, ...], [/testdata/tpch/data/partsupp/14.parquet:251447..748674, /testdata/tpch/data/partsupp/15.parquet:0..744298, /testdata/tpch/data/partsupp/16.parquet:0..748035, /testdata/tpch/data/partsupp/2.parquet:0..753010, /testdata/tpch/data/partsupp/3.parquet:0..756405, ...], [/testdata/tpch/data/partsupp/4.parquet:498158..746724, /testdata/tpch/data/partsupp/5.parquet:0..746720, /testdata/tpch/data/partsupp/6.parquet:0..750184, /testdata/tpch/data/partsupp/7.parquet:0..748095, /testdata/tpch/data/partsupp/8.parquet:0..750205, ...]]}, projection=[ps_partkey, ps_suppkey], file_type=parquet
              └──────────────────────────────────────────────────
                ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
                │ CoalesceBatchesExec: target_batch_size=8192
                │   FilterExec: s_comment@1 LIKE %Customer%Complaints%, projection=[s_suppkey@0]
                │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
                │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet, /testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet, /testdata/tpch/data/supplier/13.parquet, ...], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet, /testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet, /testdata/tpch/data/supplier/4.parquet, ...], [/testdata/tpch/data/supplier/6.parquet, /testdata/tpch/data/supplier/7.parquet, /testdata/tpch/data/supplier/8.parquet, /testdata/tpch/data/supplier/9.parquet]]}, projection=[s_suppkey, s_comment], file_type=parquet, predicate=s_comment@1 LIKE %Customer%Complaints%
                └──────────────────────────────────────────────────
                ┌───── Stage 2   Tasks: t0:[p0] t1:[p1] t2:[p2] 
                │ CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_17() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │           CoalesceBatchesExec: target_batch_size=8192
          │             NetworkShuffleExec read_from=Stage 3, output_partitions=3, n_tasks=4, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 2   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([p_partkey@2], 12), input_partitions=3
            ...
            │         CoalescePartitionsExec
            │           NetworkCoalesceExec read_from=Stage 1, output_partitions=3, input_tasks=3
            │         DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_partkey, l_quantity, l_extendedprice], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: p_brand@1 = Brand#23 AND p_container@2 = MED BOX, projection=[p_partkey@0]
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet, /testdata/tpch/data/part/10.parquet, /testdata/tpch/data/part/11.parquet, /testdata/tpch/data/part/12.parquet, /testdata/tpch/data/part/13.parquet, ...], [/testdata/tpch/data/part/15.parquet, /testdata/tpch/data/part/16.parquet, /testdata/tpch/data/part/2.parquet, /testdata/tpch/data/part/3.parquet, /testdata/tpch/data/part/4.parquet, ...], [/testdata/tpch/data/part/6.parquet, /testdata/tpch/data/part/7.parquet, /testdata/tpch/data/part/8.parquet, /testdata/tpch/data/part/9.parquet]]}, projection=[p_partkey, p_brand, p_container], file_type=parquet, predicate=p_brand@1 = Brand#23 AND p_container@2 = MED BOX, pruning_predicate=p_brand_null_count@2 != row_count@3 AND p_brand_min@0 <= Brand#23 AND Brand#23 <= p_brand_max@1 AND p_container_null_count@6 != row_count@3 AND p_container_min@4 <= MED BOX AND MED BOX <= p_container_max@5, required_guarantees=[p_brand in (Brand#23), p_container in (MED BOX)]
              └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
            │ RepartitionExec: partitioning=Hash([l_partkey@0], 12), input_partitions=1
            │   AggregateExec: mode=Partial, gby=[l_partkey@0 as l_partkey], aggr=[avg(lineitem.l_quantity)]
            │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
            │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_partkey, l_quantity], file_type=parquet
            └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_18() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 7   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([c_name@0, c_custkey@1, o_orderkey@2, o_orderdate@3, o_totalprice@4], 12), input_partitions=3
            ...
            └──────────────────────────────────────────────────
              ...
              └──────────────────────────────────────────────────
                ...
                │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
                │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_quantity], file_type=parquet
                └──────────────────────────────────────────────────
              ┌───── Stage 5   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] t3:[p9,p10,p11] 
              │ RepartitionExec: partitioning=Hash([o_orderkey@2], 3), input_partitions=3
              │   CoalesceBatchesExec: target_batch_size=8192
              ...
              └──────────────────────────────────────────────────
                ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
                │ RepartitionExec: partitioning=Hash([c_custkey@0], 12), input_partitions=1
                │   PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
                │     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet, /testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet, /testdata/tpch/data/customer/13.parquet, ...], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet, /testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet, /testdata/tpch/data/customer/4.parquet, ...], [/testdata/tpch/data/customer/6.parquet, /testdata/tpch/data/customer/7.parquet, /testdata/tpch/data/customer/8.parquet, /testdata/tpch/data/customer/9.parquet]]}, projection=[c_custkey, c_name], file_type=parquet
                └──────────────────────────────────────────────────
                ┌───── Stage 4   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] t1:[p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23] t2:[p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35] 
                │ RepartitionExec: partitioning=Hash([o_custkey@1], 12), input_partitions=1
                │   PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
                │     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..817463, /testdata/tpch/data/orders/11.parquet:0..816070, /testdata/tpch/data/orders/12.parquet:0..820827, /testdata/tpch/data/orders/13.parquet:0..821995, ...], [/testdata/tpch/data/orders/14.parquet:266845..815509, /testdata/tpch/data/orders/15.parquet:0..815233, /testdata/tpch/data/orders/16.parquet:0..817706, /testdata/tpch/data/orders/2.parquet:0..817737, /testdata/tpch/data/orders/3.parquet:0..817566, ...], [/testdata/tpch/data/orders/4.parquet:544564..821332, /testdata/tpch/data/orders/5.parquet:0..815888, /testdata/tpch/data/orders/6.parquet:0..815311, /testdata/tpch/data/orders/7.parquet:0..820001, /testdata/tpch/data/orders/8.parquet:0..817309, ...]]}, projection=[o_orderkey, o_custkey, o_totalprice, o_orderdate], file_type=parquet
                └──────────────────────────────────────────────────
              ┌───── Stage 6   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] 
              │ RepartitionExec: partitioning=Hash([l_orderkey@0], 3), input_partitions=1
              │   PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │     DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_quantity], file_type=parquet
              └──────────────────────────────────────────────────
        ");
    ...
    async fn test_tpch_20() -> Result<(), Box<dyn Error>> {
        ...
        │               CoalescePartitionsExec
        │                 NetworkCoalesceExec read_from=Stage 1, output_partitions=3, input_tasks=3
        │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet, /testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet, /testdata/tpch/data/supplier/13.parquet, ...], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet, /testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet, /testdata/tpch/data/supplier/4.parquet, ...], [/testdata/tpch/data/supplier/6.parquet, /testdata/tpch/data/supplier/7.parquet, /testdata/tpch/data/supplier/8.parquet, /testdata/tpch/data/supplier/9.parquet]]}, projection=[s_suppkey, s_name, s_address, s_nationkey], file_type=parquet
        │         CoalesceBatchesExec: target_batch_size=8192
        ...
        │                   CoalescePartitionsExec
        │                     NetworkCoalesceExec read_from=Stage 2, output_partitions=3, input_tasks=3
        │                   DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/partsupp/1.parquet:0..753508, /testdata/tpch/data/partsupp/10.parquet:0..748125, /testdata/tpch/data/partsupp/11.parquet:0..744689, /testdata/tpch/data/partsupp/12.parquet:0..749068, /testdata/tpch/data/partsupp/13.parquet:0..750296, ...], [/testdata/tpch/data/partsupp/14.parquet:251447..748674, /testdata/tpch/data/partsupp/15.parquet:0..744298, /testdata/tpch/data/partsupp/16.parquet:0..748035, /testdata/tpch/data/partsupp/2.parquet:0..753010, /testdata/tpch/data/partsupp/3.parquet:0..756405, ...], [/testdata/tpch/data/partsupp/4.parquet:498158..746724, /testdata/tpch/data/partsupp/5.parquet:0..746720, /testdata/tpch/data/partsupp/6.parquet:0..750184, /testdata/tpch/data/partsupp/7.parquet:0..748095, /testdata/tpch/data/partsupp/8.parquet:0..750205, ...]]}, projection=[ps_partkey, ps_suppkey, ps_availqty], file_type=parquet
        ...
        └──────────────────────────────────────────────────
          ...
          │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
          │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet, /testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet, /testdata/tpch/data/nation/13.parquet, ...], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet, /testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet, /testdata/tpch/data/nation/4.parquet, ...], [/testdata/tpch/data/nation/6.parquet, /testdata/tpch/data/nation/7.parquet, /testdata/tpch/data/nation/8.parquet, /testdata/tpch/data/nation/9.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = CANADA, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= CANADA AND CANADA <= n_name_max@1, required_guarantees=[n_name in (CANADA)]
          └──────────────────────────────────────────────────
          ┌───── Stage 2   Tasks: t0:[p0] t1:[p1] t2:[p2] 
          │ CoalesceBatchesExec: target_batch_size=8192
          │   FilterExec: p_name@1 LIKE forest%, projection=[p_partkey@0]
          │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
          │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/part/1.parquet, /testdata/tpch/data/part/10.parquet, /testdata/tpch/data/part/11.parquet, /testdata/tpch/data/part/12.parquet, /testdata/tpch/data/part/13.parquet, ...], [/testdata/tpch/data/part/15.parquet, /testdata/tpch/data/part/16.parquet, /testdata/tpch/data/part/2.parquet, /testdata/tpch/data/part/3.parquet, /testdata/tpch/data/part/4.parquet, ...], [/testdata/tpch/data/part/6.parquet, /testdata/tpch/data/part/7.parquet, /testdata/tpch/data/part/8.parquet, /testdata/tpch/data/part/9.parquet]]}, projection=[p_partkey, p_name], file_type=parquet, predicate=p_name@1 LIKE forest%, pruning_predicate=p_name_null_count@2 != row_count@3 AND p_name_min@0 <= foresu AND forest <= p_name_max@1, required_guarantees=[]
          └──────────────────────────────────────────────────
          ┌───── Stage 3   Tasks: t0:[p0,p1,p2] t1:[p3,p4,p5] t2:[p6,p7,p8] 
          │ RepartitionExec: partitioning=Hash([l_partkey@0, l_suppkey@1], 3), input_partitions=1
          ...
          │         PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
          │           DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_partkey, l_suppkey, l_quantity, l_shipdate], file_type=parquet, predicate=l_shipdate@3 >= 1994-01-01 AND l_shipdate@3 < 1995-01-01, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1994-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1995-01-01, required_guarantees=[]
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_21() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([s_name@0], 12), input_partitions=3
            ...
            │                             CoalescePartitionsExec
            │                               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/supplier/1.parquet, /testdata/tpch/data/supplier/10.parquet, /testdata/tpch/data/supplier/11.parquet, /testdata/tpch/data/supplier/12.parquet, /testdata/tpch/data/supplier/13.parquet, ...], [/testdata/tpch/data/supplier/15.parquet, /testdata/tpch/data/supplier/16.parquet, /testdata/tpch/data/supplier/2.parquet, /testdata/tpch/data/supplier/3.parquet, /testdata/tpch/data/supplier/4.parquet, ...], [/testdata/tpch/data/supplier/6.parquet, /testdata/tpch/data/supplier/7.parquet, /testdata/tpch/data/supplier/8.parquet, /testdata/tpch/data/supplier/9.parquet]]}, projection=[s_suppkey, s_name, s_nationkey], file_type=parquet
            │                             CoalesceBatchesExec: target_batch_size=8192
            │                               FilterExec: l_receiptdate@3 > l_commitdate@2, projection=[l_orderkey@0, l_suppkey@1]
            │                                 DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_suppkey, l_commitdate, l_receiptdate], file_type=parquet, predicate=l_receiptdate@3 > l_commitdate@2
            │               DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_suppkey], file_type=parquet
            │         CoalesceBatchesExec: target_batch_size=8192
            │           FilterExec: l_receiptdate@3 > l_commitdate@2, projection=[l_orderkey@0, l_suppkey@1]
            │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/lineitem/1.parquet:0..2263630, /testdata/tpch/data/lineitem/10.parquet:0..2247315, /testdata/tpch/data/lineitem/11.parquet:0..2257665, /testdata/tpch/data/lineitem/12.parquet:0..2246562, /testdata/tpch/data/lineitem/13.parquet:0..2280549, ...], [/testdata/tpch/data/lineitem/14.parquet:720755..2262883, /testdata/tpch/data/lineitem/15.parquet:0..2235696, /testdata/tpch/data/lineitem/16.parquet:0..2266608, /testdata/tpch/data/lineitem/2.parquet:0..2246598, /testdata/tpch/data/lineitem/3.parquet:0..2273582, ...], [/testdata/tpch/data/lineitem/4.parquet:1451864..2243067, /testdata/tpch/data/lineitem/5.parquet:0..2258249, /testdata/tpch/data/lineitem/6.parquet:0..2240773, /testdata/tpch/data/lineitem/7.parquet:0..2241893, /testdata/tpch/data/lineitem/8.parquet:0..2231719, ...]]}, projection=[l_orderkey, l_suppkey, l_commitdate, l_receiptdate], file_type=parquet, predicate=l_receiptdate@3 > l_commitdate@2
            └──────────────────────────────────────────────────
              ...
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/nation/1.parquet, /testdata/tpch/data/nation/10.parquet, /testdata/tpch/data/nation/11.parquet, /testdata/tpch/data/nation/12.parquet, /testdata/tpch/data/nation/13.parquet, ...], [/testdata/tpch/data/nation/15.parquet, /testdata/tpch/data/nation/16.parquet, /testdata/tpch/data/nation/2.parquet, /testdata/tpch/data/nation/3.parquet, /testdata/tpch/data/nation/4.parquet, ...], [/testdata/tpch/data/nation/6.parquet, /testdata/tpch/data/nation/7.parquet, /testdata/tpch/data/nation/8.parquet, /testdata/tpch/data/nation/9.parquet]]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = SAUDI ARABIA, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= SAUDI ARABIA AND SAUDI ARABIA <= n_name_max@1, required_guarantees=[n_name in (SAUDI ARABIA)]
              └──────────────────────────────────────────────────
              ┌───── Stage 2   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   FilterExec: o_orderstatus@1 = F, projection=[o_orderkey@0]
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..817463, /testdata/tpch/data/orders/11.parquet:0..816070, /testdata/tpch/data/orders/12.parquet:0..820827, /testdata/tpch/data/orders/13.parquet:0..821995, ...], [/testdata/tpch/data/orders/14.parquet:266845..815509, /testdata/tpch/data/orders/15.parquet:0..815233, /testdata/tpch/data/orders/16.parquet:0..817706, /testdata/tpch/data/orders/2.parquet:0..817737, /testdata/tpch/data/orders/3.parquet:0..817566, ...], [/testdata/tpch/data/orders/4.parquet:544564..821332, /testdata/tpch/data/orders/5.parquet:0..815888, /testdata/tpch/data/orders/6.parquet:0..815311, /testdata/tpch/data/orders/7.parquet:0..820001, /testdata/tpch/data/orders/8.parquet:0..817309, ...]]}, projection=[o_orderkey, o_orderstatus], file_type=parquet, predicate=o_orderstatus@1 = F, pruning_predicate=o_orderstatus_null_count@2 != row_count@3 AND o_orderstatus_min@0 <= F AND F <= o_orderstatus_max@1, required_guarantees=[o_orderstatus in (F)]
              └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_22() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 3   Tasks: t0:[p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11] 
            │ RepartitionExec: partitioning=Hash([cntrycode@0], 12), input_partitions=3
            ...
            │             CoalescePartitionsExec
            │               NetworkCoalesceExec read_from=Stage 2, output_partitions=3, input_tasks=3
            │             DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/orders/1.parquet:0..818270, /testdata/tpch/data/orders/10.parquet:0..817463, /testdata/tpch/data/orders/11.parquet:0..816070, /testdata/tpch/data/orders/12.parquet:0..820827, /testdata/tpch/data/orders/13.parquet:0..821995, ...], [/testdata/tpch/data/orders/14.parquet:266845..815509, /testdata/tpch/data/orders/15.parquet:0..815233, /testdata/tpch/data/orders/16.parquet:0..817706, /testdata/tpch/data/orders/2.parquet:0..817737, /testdata/tpch/data/orders/3.parquet:0..817566, ...], [/testdata/tpch/data/orders/4.parquet:544564..821332, /testdata/tpch/data/orders/5.parquet:0..815888, /testdata/tpch/data/orders/6.parquet:0..815311, /testdata/tpch/data/orders/7.parquet:0..820001, /testdata/tpch/data/orders/8.parquet:0..817309, ...]]}, projection=[o_custkey], file_type=parquet
            └──────────────────────────────────────────────────
              ┌───── Stage 1   Tasks: t0:[p0] t1:[p1] t2:[p2] 
              ...
              │     PartitionIsolatorExec Tasks: t0:[p0,__,__] t1:[__,p0,__] t2:[__,__,p0] 
              │       DataSourceExec: file_groups={3 groups: [[/testdata/tpch/data/customer/1.parquet, /testdata/tpch/data/customer/10.parquet, /testdata/tpch/data/customer/11.parquet, /testdata/tpch/data/customer/12.parquet, /testdata/tpch/data/customer/13.parquet, ...], [/testdata/tpch/data/customer/15.parquet, /testdata/tpch/data/customer/16.parquet, /testdata/tpch/data/customer/2.parquet, /testdata/tpch/data/customer/3.parquet, /testdata/tpch/data/customer/4.parquet, ...], [/testdata/tpch/data/customer/6.parquet, /testdata/tpch/data/customer/7.parquet, /testdata/tpch/data/customer/8.parquet, /testdata/tpch/data/customer/9.parquet]]}, projection=[c_custkey, c_phone, c_acctbal], file_type=parquet, predicate=substr(c_phone@1, 1, 2) IN ([Literal { value: Utf8View("13"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("31"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("23"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("29"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("30"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("18"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }, Literal { value: Utf8View("17"), field: Field { name: "lit", data_type: Utf8View, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} } }])
              └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
    ...
    async fn run_tpch_query(ctx_d: SessionContext, query_id: u8) -> Result<String, Box<dyn Error>> {
        ...
        let config_s = SessionConfig::new().with_target_partitions(3);
