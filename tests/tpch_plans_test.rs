...
mod tests {
    ...
    async fn test_tpch_1() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=2, local_partitions=8, exprs=[l_returnflag@0, l_linestatus@1]
          │         [Stage 1] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p1] t1:[p0..p1] t2:[p0..p1] t3:[p0..p1] 
            │ RepartitionExec: partitioning=Hash([l_returnflag@0, l_linestatus@1], 2), input_partitions=4
    ...
    async fn test_tpch_2() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 11] => NetworkCoalesceExec: output_partitions=32, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 11 ── Tasks: t0:[p0..p7] t1:[p0..p7] t2:[p0..p7] t3:[p0..p7] 
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=4, local_partitions=8, exprs=[p_partkey@0, ps_supplycost@7]
          │         [Stage 5] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=4, local_partitions=8, exprs=[ps_partkey@1, min(partsupp.ps_supplycost)@0]
          │         [Stage 10] => NetworkShuffleExec: output_partitions=1, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p3] t1:[p0..p3] t2:[p0..p3] t3:[p0..p3] 
            ...
            └──────────────────────────────────────────────────
              ...
              └──────────────────────────────────────────────────
            ┌───── Stage 10 ── Tasks: t0:[p0..p3] t1:[p0..p3] t2:[p0..p3] 
            │ RepartitionExec: partitioning=Hash([ps_partkey@1, min(partsupp.ps_supplycost)@0], 4), input_partitions=8
            ...
            │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[ps_partkey@0]
            │         [Stage 9] => NetworkShuffleExec: output_partitions=1, input_tasks=4
            └──────────────────────────────────────────────────
              ┌───── Stage 9 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2] t3:[p0..p2] 
              │ RepartitionExec: partitioning=Hash([ps_partkey@0], 3), input_partitions=4
    ...
    async fn test_tpch_3() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 4] => NetworkCoalesceExec: output_partitions=24, input_tasks=3
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[l_orderkey@0, o_orderdate@1, o_shippriority@2]
          │         [Stage 3] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
    ...
    async fn test_tpch_5() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 7] => NetworkCoalesceExec: output_partitions=24, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 7 ── Tasks: t0:[p0..p7] t1:[p0..p7] t2:[p0..p7] 
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[n_name@0]
          │         [Stage 6] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
    ...
    async fn test_tpch_7() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[supp_nation@0, cust_nation@1, l_year@2]
          │         [Stage 6] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 6 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2] t3:[p0..p2] 
            │ RepartitionExec: partitioning=Hash([supp_nation@0, cust_nation@1, l_year@2], 3), input_partitions=4
    ...
    async fn test_tpch_8() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 9] => NetworkCoalesceExec: output_partitions=24, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 9 ── Tasks: t0:[p0..p7] t1:[p0..p7] t2:[p0..p7] 
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[o_year@0]
          │         [Stage 8] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 8 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2] t3:[p0..p2] 
            │ RepartitionExec: partitioning=Hash([o_year@0], 3), input_partitions=4
    ...
    async fn test_tpch_9() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[nation@0, o_year@1]
          │         [Stage 6] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 6 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2] t3:[p0..p2] 
            │ RepartitionExec: partitioning=Hash([nation@0, o_year@1], 3), input_partitions=4
    ...
    async fn test_tpch_10() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 5] => NetworkCoalesceExec: output_partitions=24, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 5 ── Tasks: t0:[p0..p7] t1:[p0..p7] t2:[p0..p7] 
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[c_custkey@0, c_name@1, c_acctbal@2, c_phone@3, n_name@4, c_address@5, c_comment@6]
          │         [Stage 4] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
    ...
    async fn test_tpch_11() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │     DataSourceExec: file_groups={16 groups: [[/testdata/tpch/plan_sf0.02/supplier/1.parquet], [/testdata/tpch/plan_sf0.02/supplier/10.parquet], [/testdata/tpch/plan_sf0.02/supplier/11.parquet], [/testdata/tpch/plan_sf0.02/supplier/12.parquet], [/testdata/tpch/plan_sf0.02/supplier/13.parquet], ...]}, projection=[s_suppkey, s_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
          ┌───── Stage 6 ── Tasks: t0:[p0] t1:[p0] t2:[p0] t3:[p0] 
          │ RepartitionExec: partitioning=Hash([ps_partkey@0], 1), input_partitions=4
    ...
    async fn test_tpch_12() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 3] => NetworkCoalesceExec: output_partitions=24, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 3 ── Tasks: t0:[p0..p7] t1:[p0..p7] t2:[p0..p7] 
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[l_shipmode@0]
          │         [Stage 2] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 2 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2] t3:[p0..p2] 
            │ RepartitionExec: partitioning=Hash([l_shipmode@0], 3), input_partitions=4
    ...
    async fn test_tpch_13() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=2, local_partitions=8, exprs=[c_count@0]
          │         [Stage 2] => NetworkShuffleExec: output_partitions=1, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 2 ── Tasks: t0:[p0..p1] t1:[p0..p1] t2:[p0..p1] 
            │ RepartitionExec: partitioning=Hash([c_count@0], 2), input_partitions=8
            ...
            │         LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[c_custkey@0]
            │           [Stage 1] => NetworkShuffleExec: output_partitions=1, input_tasks=4
            └──────────────────────────────────────────────────
              ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2] t3:[p0..p2] 
              │ RepartitionExec: partitioning=Hash([c_custkey@0], 3), input_partitions=4
    ...
    async fn test_tpch_15() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 6] => NetworkCoalesceExec: output_partitions=32, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 6 ── Tasks: t0:[p0..p7] t1:[p0..p7] t2:[p0..p7] t3:[p0..p7] 
          ...
          │           LocalExchangeSplitExec: input_partitions=1, base_partitions=4, local_partitions=8, exprs=[l_suppkey@0]
          │             [Stage 5] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ...
              │     AggregateExec: mode=FinalPartitioned, gby=[l_suppkey@0 as l_suppkey], aggr=[sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)]
              │       LocalExchangeSplitExec: input_partitions=1, base_partitions=2, local_partitions=8, exprs=[l_suppkey@0]
              │         [Stage 1] => NetworkShuffleExec: output_partitions=1, input_tasks=4
              └──────────────────────────────────────────────────
                ┌───── Stage 1 ── Tasks: t0:[p0..p1] t1:[p0..p1] t2:[p0..p1] t3:[p0..p1] 
                │ RepartitionExec: partitioning=Hash([l_suppkey@0], 2), input_partitions=4
    ...
    async fn test_tpch_16() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 5] => NetworkCoalesceExec: output_partitions=16, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 5 ── Tasks: t0:[p0..p7] t1:[p0..p7] 
          ...
          │       LocalExchangeSplitExec: input_partitions=1, base_partitions=2, local_partitions=8, exprs=[p_brand@0, p_type@1, p_size@2]
          │         [Stage 4] => NetworkShuffleExec: output_partitions=1, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 4 ── Tasks: t0:[p0..p1] t1:[p0..p1] t2:[p0..p1] 
            │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2], 2), input_partitions=8
            ...
            │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[p_brand@0, p_type@1, p_size@2, alias1@3]
            │         [Stage 3] => NetworkShuffleExec: output_partitions=1, input_tasks=4
            └──────────────────────────────────────────────────
              ┌───── Stage 3 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2] t3:[p0..p2] 
              │ RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2, alias1@3], 3), input_partitions=4
    ...
    async fn test_tpch_17() -> Result<(), Box<dyn Error>> {
        ...
        │     CoalescePartitionsExec
        │       [Stage 4] => NetworkCoalesceExec: output_partitions=32, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 4 ── Tasks: t0:[p0..p7] t1:[p0..p7] t2:[p0..p7] t3:[p0..p7] 
          ...
          │         LocalExchangeSplitExec: input_partitions=1, base_partitions=4, local_partitions=8, exprs=[l_partkey@0]
          │           [Stage 3] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 2 ── Tasks: t0:[p0..p15] t1:[p16..p31] t2:[p32..p47] t3:[p48..p63] 
            │ BroadcastExec: input_partitions=4, consumer_tasks=4, output_partitions=16
            ...
            └──────────────────────────────────────────────────
              ...
              └──────────────────────────────────────────────────
            ┌───── Stage 3 ── Tasks: t0:[p0..p3] t1:[p0..p3] t2:[p0..p3] t3:[p0..p3] 
    ...
    async fn test_tpch_18() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 6] => NetworkCoalesceExec: output_partitions=24, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 6 ── Tasks: t0:[p0..p7] t1:[p0..p7] t2:[p0..p7] 
          ...
          │     LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[c_name@0, c_custkey@1, o_orderkey@2, o_orderdate@3, o_totalprice@4]
          │       [Stage 5] => NetworkShuffleExec: output_partitions=1, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2] t3:[p0..p2] 
            │ RepartitionExec: partitioning=Hash([c_name@0, c_custkey@1, o_orderkey@2, o_orderdate@3, o_totalprice@4], 3), input_partitions=4
            ...
            │       CoalescePartitionsExec
            │         [Stage 2] => NetworkBroadcastExec: partitions_per_consumer=8, stage_partitions=32, input_tasks=3
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 2 ── Tasks: t0:[p0..p31] t1:[p32..p63] t2:[p64..p95] 
              │ BroadcastExec: input_partitions=8, consumer_tasks=4, output_partitions=32
              ...
              │       LocalExchangeSplitExec: input_partitions=1, base_partitions=3, local_partitions=8, exprs=[l_orderkey@0]
              │         [Stage 1] => NetworkShuffleExec: output_partitions=1, input_tasks=4
              └──────────────────────────────────────────────────
                ┌───── Stage 1 ── Tasks: t0:[p0..p2] t1:[p0..p2] t2:[p0..p2] t3:[p0..p2] 
                │ RepartitionExec: partitioning=Hash([l_orderkey@0], 3), input_partitions=4
    ...
    async fn test_tpch_20() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
          ┌───── Stage 4 ── Tasks: t0:[p0] t1:[p0] t2:[p0] t3:[p0] 
          │ RepartitionExec: partitioning=Hash([l_partkey@0, l_suppkey@1], 1), input_partitions=4
