...
mod tests {
    ...
    async fn test_tpch_2() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 14] => NetworkCoalesceExec: output_partitions=24, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 14 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5] 
          ...
          │         [Stage 7] => NetworkShuffleExec: output_partitions=6, input_tasks=3
          │         [Stage 13] => NetworkShuffleExec: output_partitions=6, input_tasks=3
          └──────────────────────────────────────────────────
            ┌───── Stage 7 ── Tasks: t0:[p0..p23] t1:[p0..p23] t2:[p0..p23] 
            │ CoalesceBatchesExec: target_batch_size=8192
            │   RepartitionExec: partitioning=Hash([p_partkey@0, ps_supplycost@7], 24), input_partitions=2
            │     CoalesceBatchesExec: target_batch_size=8192
            ...
            │         [Stage 2] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
            ...
            │                     [Stage 4] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
            │                     CoalesceBatchesExec: target_batch_size=8192
            ...
            │                         [Stage 6] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
            ...
            └──────────────────────────────────────────────────
              ...
              ┌───── Stage 6 ── Tasks: t0:[p0] 
              │ CoalescePartitionsExec
              │   [Stage 5] => NetworkCoalesceExec: output_partitions=8, input_tasks=4
              └──────────────────────────────────────────────────
                ┌───── Stage 5 ── Tasks: t0:[p0..p1] t1:[p2..p3] t2:[p4..p5] t3:[p6..p7] 
                │ CoalesceBatchesExec: target_batch_size=8192
                ...
                └──────────────────────────────────────────────────
            ┌───── Stage 13 ── Tasks: t0:[p0..p23] t1:[p0..p23] t2:[p0..p23] 
            │ CoalesceBatchesExec: target_batch_size=8192
            ...
            │         [Stage 12] => NetworkShuffleExec: output_partitions=6, input_tasks=3
            └──────────────────────────────────────────────────
              ┌───── Stage 12 ── Tasks: t0:[p0..p17] t1:[p0..p17] t2:[p0..p17] 
              │ CoalesceBatchesExec: target_batch_size=8192
              │   RepartitionExec: partitioning=Hash([ps_partkey@0], 18), input_partitions=2
              ...
              │           [Stage 9] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
              ...
              │                 [Stage 10] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
              ...
              │                       [Stage 11] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
              │                       PartitionIsolatorExec: t0:[p0,p1,__,__,__,__] t1:[__,__,p0,p1,__,__] t2:[__,__,__,__,p0,p1] 
              ...
              └──────────────────────────────────────────────────
                ┌───── Stage 9 ── Tasks: t0:[p0] 
                │ CoalescePartitionsExec
                │   [Stage 8] => NetworkCoalesceExec: output_partitions=8, input_tasks=4
                └──────────────────────────────────────────────────
                  ┌───── Stage 8 ── Tasks: t0:[p0..p1] t1:[p2..p3] t2:[p4..p5] t3:[p6..p7] 
                  │ CoalesceBatchesExec: target_batch_size=8192
                  │   FilterExec: r_name@1 = EUROPE, projection=[r_regionkey@0]
                  │     PartitionIsolatorExec: t0:[p0,p1,__,__,__,__] t1:[__,__,p0,p1,__,__] t2:[__,__,__,__,p0,__] t3:[__,__,__,__,__,p0] 
                  │       DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf0.02/region/1.parquet, /testdata/tpch/plan_sf0.02/region/10.parquet, /testdata/tpch/plan_sf0.02/region/11.parquet], [/testdata/tpch/plan_sf0.02/region/12.parquet, /testdata/tpch/plan_sf0.02/region/13.parquet, /testdata/tpch/plan_sf0.02/region/14.parquet], [/testdata/tpch/plan_sf0.02/region/15.parquet, /testdata/tpch/plan_sf0.02/region/16.parquet, /testdata/tpch/plan_sf0.02/region/2.parquet], [/testdata/tpch/plan_sf0.02/region/3.parquet, /testdata/tpch/plan_sf0.02/region/4.parquet, /testdata/tpch/plan_sf0.02/region/5.parquet], [/testdata/tpch/plan_sf0.02/region/6.parquet, /testdata/tpch/plan_sf0.02/region/7.parquet, /testdata/tpch/plan_sf0.02/region/8.parquet], ...]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = EUROPE, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= EUROPE AND EUROPE <= r_name_max@1, required_guarantees=[r_name in (EUROPE)]
    ...
    async fn test_tpch_3() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │ CoalesceBatchesExec: target_batch_size=8192
            │   RepartitionExec: partitioning=Hash([l_orderkey@0, o_orderdate@1, o_shippriority@2], 18), input_partitions=2
    ...
    async fn test_tpch_4() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │ CoalesceBatchesExec: target_batch_size=8192
            │   RepartitionExec: partitioning=Hash([o_orderpriority@0], 18), input_partitions=2
    ...
    async fn test_tpch_5() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 10] => NetworkCoalesceExec: output_partitions=18, input_tasks=3
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 9 ── Tasks: t0:[p0..p17] t1:[p0..p17] t2:[p0..p17] 
            │ CoalesceBatchesExec: target_batch_size=8192
            │   RepartitionExec: partitioning=Hash([n_name@0], 18), input_partitions=2
            ...
            │                           [Stage 8] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
            │                           PartitionIsolatorExec: t0:[p0,p1,__,__,__,__] t1:[__,__,p0,p1,__,__] t2:[__,__,__,__,p0,p1] 
    ...
    async fn test_tpch_7() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 12] => NetworkCoalesceExec: output_partitions=18, input_tasks=3
        └──────────────────────────────────────────────────
          ...
          │       [Stage 11] => NetworkShuffleExec: output_partitions=6, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 11 ── Tasks: t0:[p0..p17] 
            │ CoalesceBatchesExec: target_batch_size=8192
            ...
            │                         [Stage 7] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
            │                         CoalesceBatchesExec: target_batch_size=8192
            ...
            └──────────────────────────────────────────────────
              ...
              │ CoalesceBatchesExec: target_batch_size=8192
              │   RepartitionExec: partitioning=Hash([l_orderkey@1], 6), input_partitions=2
              │     CoalesceBatchesExec: target_batch_size=8192
              ...
              │     PartitionIsolatorExec: t0:[p0,p1,__,__,__,__] t1:[__,__,p0,p1,__,__] t2:[__,__,__,__,p0,__] t3:[__,__,__,__,__,p0] 
              │       DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf0.02/orders/1.parquet, /testdata/tpch/plan_sf0.02/orders/10.parquet, /testdata/tpch/plan_sf0.02/orders/11.parquet], [/testdata/tpch/plan_sf0.02/orders/12.parquet, /testdata/tpch/plan_sf0.02/orders/13.parquet, /testdata/tpch/plan_sf0.02/orders/14.parquet], [/testdata/tpch/plan_sf0.02/orders/15.parquet, /testdata/tpch/plan_sf0.02/orders/16.parquet, /testdata/tpch/plan_sf0.02/orders/2.parquet], [/testdata/tpch/plan_sf0.02/orders/3.parquet, /testdata/tpch/plan_sf0.02/orders/4.parquet, /testdata/tpch/plan_sf0.02/orders/5.parquet], [/testdata/tpch/plan_sf0.02/orders/6.parquet, /testdata/tpch/plan_sf0.02/orders/7.parquet, /testdata/tpch/plan_sf0.02/orders/8.parquet], ...]}, projection=[o_orderkey, o_custkey], file_type=parquet, predicate=DynamicFilter [ empty ] AND DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_8() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 13] => NetworkCoalesceExec: output_partitions=18, input_tasks=3
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 12 ── Tasks: t0:[p0..p17] t1:[p0..p17] t2:[p0..p17] 
            │ CoalesceBatchesExec: target_batch_size=8192
            │   RepartitionExec: partitioning=Hash([o_year@0], 18), input_partitions=2
          ...
          └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ...
              └──────────────────────────────────────────────────
                ...
                │ CoalesceBatchesExec: target_batch_size=8192
                │   RepartitionExec: partitioning=Hash([l_suppkey@2, l_partkey@1], 24), input_partitions=2
    ...
    async fn test_tpch_10() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │ CoalesceBatchesExec: target_batch_size=8192
            │   RepartitionExec: partitioning=Hash([c_custkey@0, c_name@1, c_acctbal@2, c_phone@3, n_name@4, c_address@5, c_comment@6], 18), input_partitions=2
            ...
            │             [Stage 1] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
            │             CoalesceBatchesExec: target_batch_size=8192
            ...
            │                 [Stage 5] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
            │                 CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_11() -> Result<(), Box<dyn Error>> {
        ...
        │             [Stage 8] => NetworkShuffleExec: output_partitions=6, input_tasks=3
        └──────────────────────────────────────────────────
          ┌───── Stage 4 ── Tasks: t0:[p0..p1] t1:[p2..p3] t2:[p4..p5] 
          ...
          │ CoalesceBatchesExec: target_batch_size=8192
          │   RepartitionExec: partitioning=Hash([ps_partkey@0], 6), input_partitions=2
    ...
    async fn test_tpch_14() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │             PartitionIsolatorExec: t0:[p0,p1,__,__,__,__] t1:[__,__,p0,p1,__,__] t2:[__,__,__,__,p0,__] t3:[__,__,__,__,__,p0] 
          │               DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf0.02/lineitem/1.parquet, /testdata/tpch/plan_sf0.02/lineitem/10.parquet, /testdata/tpch/plan_sf0.02/lineitem/11.parquet], [/testdata/tpch/plan_sf0.02/lineitem/12.parquet, /testdata/tpch/plan_sf0.02/lineitem/13.parquet, /testdata/tpch/plan_sf0.02/lineitem/14.parquet], [/testdata/tpch/plan_sf0.02/lineitem/15.parquet, /testdata/tpch/plan_sf0.02/lineitem/16.parquet, /testdata/tpch/plan_sf0.02/lineitem/2.parquet], [/testdata/tpch/plan_sf0.02/lineitem/3.parquet, /testdata/tpch/plan_sf0.02/lineitem/4.parquet, /testdata/tpch/plan_sf0.02/lineitem/5.parquet], [/testdata/tpch/plan_sf0.02/lineitem/6.parquet, /testdata/tpch/plan_sf0.02/lineitem/7.parquet, /testdata/tpch/plan_sf0.02/lineitem/8.parquet], ...]}, projection=[l_partkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@3 >= 1995-09-01 AND l_shipdate@3 < 1995-10-01 AND DynamicFilter [ empty ], pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1995-09-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1995-10-01, required_guarantees=[]
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0] 
            │ CoalescePartitionsExec
    ...
    async fn test_tpch_16() -> Result<(), Box<dyn Error>> {
        ...
        │   [Stage 7] => NetworkCoalesceExec: output_partitions=12, input_tasks=2
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ...
              │ CoalesceBatchesExec: target_batch_size=8192
              │   RepartitionExec: partitioning=Hash([p_brand@0, p_type@1, p_size@2, alias1@3], 18), input_partitions=2
    ...
    async fn test_tpch_18() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ┌───── Stage 7 ── Tasks: t0:[p0..p17] t1:[p0..p17] 
            │ CoalesceBatchesExec: target_batch_size=8192
            │   RepartitionExec: partitioning=Hash([c_name@0, c_custkey@1, o_orderkey@2, o_orderdate@3, o_totalprice@4], 18), input_partitions=3
    ...
    async fn test_tpch_20() -> Result<(), Box<dyn Error>> {
        ...
        │             [Stage 12] => NetworkBroadcastExec: output_partitions=1, input_tasks=1
        ...
        │                 [Stage 13] => NetworkShuffleExec: output_partitions=6, input_tasks=4
        └──────────────────────────────────────────────────
          ┌───── Stage 8 ── Tasks: t0:[p0] 
          │ CoalescePartitionsExec
          │   [Stage 7] => NetworkCoalesceExec: output_partitions=6, input_tasks=3
          ...
          └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 10 ── Tasks: t0:[p0] 
              │ CoalescePartitionsExec
              │   [Stage 9] => NetworkCoalesceExec: output_partitions=8, input_tasks=4
              └──────────────────────────────────────────────────
                ┌───── Stage 9 ── Tasks: t0:[p0..p1] t1:[p2..p3] t2:[p4..p5] t3:[p6..p7] 
                │ CoalesceBatchesExec: target_batch_size=8192
    ...
    async fn test_tpch_21() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │ CoalesceBatchesExec: target_batch_size=8192
            │   RepartitionExec: partitioning=Hash([s_name@0], 18), input_partitions=2
    ...
    async fn run_tpch_query(ctx: SessionContext, query_id: u8) -> Result<String, Box<dyn Error>> {
        ...
        eprintln!("{}", display_plan_ascii(plan.as_ref(), false));
