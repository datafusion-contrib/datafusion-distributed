...
mod tests {
    ...
    async fn test_tpch_2() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       [Stage 10] => NetworkShuffleExec: output_partitions=6, input_tasks=1
          └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p17] t1:[p0..p17] t2:[p0..p17] 
            │ RepartitionExec: partitioning=Hash([p_partkey@0, ps_supplycost@7], 18), input_partitions=5
            ...
            │         CoalescePartitionsExec
            │           [Stage 2] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=18, input_tasks=1
            ...
            │             CoalescePartitionsExec
            │               [Stage 3] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=18, input_tasks=1
            ...
            │               PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,p0,p1,p2,p3,p4,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4]
            │                 DataSourceExec: file_groups={15 groups: [[/testdata/tpch/plan_sf1/partsupp/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>], ...]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet, predicate=DynamicFilter [ empty ] AND DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
              ...
              └──────────────────────────────────────────────────
            ┌───── Stage 10 ── Tasks: t0:[p0..p17] 
            │ RepartitionExec: partitioning=Hash([ps_partkey@1, min(partsupp.ps_supplycost)@0], 18), input_partitions=6
            ...
            │       [Stage 9] => NetworkShuffleExec: output_partitions=6, input_tasks=3
            └──────────────────────────────────────────────────
              ┌───── Stage 9 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] 
              │ RepartitionExec: partitioning=Hash([ps_partkey@0], 6), input_partitions=5
              ...
              │       CoalescePartitionsExec
              │         [Stage 6] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=18, input_tasks=1
              ...
              │           CoalescePartitionsExec
              │             [Stage 7] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=18, input_tasks=1
              ...
              │               CoalescePartitionsExec
              │                 [Stage 8] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=18, input_tasks=1
              │               PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,p0,p1,p2,p3,p4,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4]
              │                 DataSourceExec: file_groups={15 groups: [[/testdata/tpch/plan_sf1/partsupp/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>], ...]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
    ...
    async fn test_tpch_3() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │       CoalescePartitionsExec
            │         [Stage 2] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=24, input_tasks=2
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 2 ── Tasks: t0:[p0..p23] t1:[p24..p47] 
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ...
              │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/2.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/7.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_custkey], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
              ┌───── Stage 6 ── Tasks: t0:[p0..p23] t1:[p0..p23] t2:[p0..p23] t3:[p0..p23] 
    ...
    async fn test_tpch_8() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/customer/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/7.parquet:<int>..<int>], ...]}, projection=[c_custkey, c_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
            ┌───── Stage 9 ── Tasks: t0:[p0..p23] t1:[p0..p23] 
            ...
            └──────────────────────────────────────────────────
              ...
              └──────────────────────────────────────────────────
              ┌───── Stage 8 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11] t3:[p0..p11] 
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ...
              │     [Stage 3] => NetworkShuffleExec: output_partitions=6, input_tasks=2
              └──────────────────────────────────────────────────
                ┌───── Stage 2 ── Tasks: t0:[p0..p17] t1:[p0..p17] 
                │ RepartitionExec: partitioning=Hash([c_custkey@0], 18), input_partitions=6
                │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
                │     DataSourceExec: file_groups={12 groups: [[/testdata/tpch/plan_sf1/customer/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/15.parquet:<int>..<int>], ...]}, projection=[c_custkey, c_name, c_address, c_nationkey, c_phone, c_acctbal, c_comment], file_type=parquet, predicate=DynamicFilter [ empty ]
                └──────────────────────────────────────────────────
                ┌───── Stage 3 ── Tasks: t0:[p0..p17] t1:[p0..p17] 
    ...
    async fn test_tpch_11() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │           CoalescePartitionsExec
          │             [Stage 5] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=18, input_tasks=1
          │           PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,p0,p1,p2,p3,p4,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4]
          │             DataSourceExec: file_groups={15 groups: [[/testdata/tpch/plan_sf1/partsupp/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>], ...]}, projection=[ps_partkey, ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet, predicate=DynamicFilter [ empty ]
          └──────────────────────────────────────────────────
            ┌───── Stage 4 ── Tasks: t0:[p0..p17] 
            │ BroadcastExec: input_partitions=6, consumer_tasks=3, output_partitions=18
            │   FilterExec: n_name@1 = GERMANY, projection=[n_nationkey@0]
    ...
    async fn test_tpch_12() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │ RepartitionExec: partitioning=Hash([l_shipmode@0], 12), input_partitions=6
            ...
            └──────────────────────────────────────────────────
              ...
              ┌───── Stage 2 ── Tasks: t0:[p0..p23] 
              │ RepartitionExec: partitioning=Hash([o_orderkey@0], 24), input_partitions=6
              │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/2.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/7.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_orderpriority], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ...
              │     PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4]
              │       DataSourceExec: file_groups={21 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_custkey, o_comment], file_type=parquet, predicate=o_comment@8 NOT LIKE %special%requests%
              └──────────────────────────────────────────────────
        ");
        Ok(())
    }
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ...
              │ RepartitionExec: partitioning=Hash([o_custkey@1], 24), input_partitions=5
              │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,p0,p1,p2,p3,p4,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4]
              │     DataSourceExec: file_groups={15 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_custkey, o_totalprice, o_orderdate], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p23] t1:[p0..p23] t2:[p0..p23] t3:[p0..p23] 
            │ RepartitionExec: partitioning=Hash([l_orderkey@0], 24), input_partitions=6
            │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4]
