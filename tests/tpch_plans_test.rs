...
mod tests {
    ...
    async fn test_tpch_1() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │           DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_quantity, l_extendedprice, l_discount, l_tax, l_returnflag, l_linestatus, l_shipdate], file_type=parquet, predicate=l_shipdate@10 <= 1998-09-02, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@0 <= 1998-09-02, required_guarantees=[]
            └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_2() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │                 DataSourceExec: file_groups={12 groups: [[/testdata/tpch/plan_sf1/partsupp/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/15.parquet:<int>..<int>], ...]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet, predicate=DynamicFilter [ empty ] AND DynamicFilter [ empty ]
          └──────────────────────────────────────────────────
            ...
            │     DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/part/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/7.parquet:<int>..<int>], ...]}, projection=[p_partkey, p_mfgr, p_type, p_size], file_type=parquet, predicate=p_size@5 = 15 AND p_type@4 LIKE %BRASS, pruning_predicate=p_size_null_count@2 != row_count@3 AND p_size_min@0 <= 15 AND 15 <= p_size_max@1, required_guarantees=[p_size in (15)]
            └──────────────────────────────────────────────────
          ...
          │               PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
          │                 DataSourceExec: file_groups={12 groups: [[/testdata/tpch/plan_sf1/partsupp/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/15.parquet:<int>..<int>], ...]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet, predicate=DynamicFilter [ empty ]
          └──────────────────────────────────────────────────
            ...
            │ BroadcastExec: input_partitions=6, consumer_tasks=2, output_partitions=12
            │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/nation/1.parquet, /testdata/tpch/plan_sf1/nation/10.parquet, /testdata/tpch/plan_sf1/nation/11.parquet], [/testdata/tpch/plan_sf1/nation/12.parquet, /testdata/tpch/plan_sf1/nation/13.parquet, /testdata/tpch/plan_sf1/nation/14.parquet], [/testdata/tpch/plan_sf1/nation/15.parquet, /testdata/tpch/plan_sf1/nation/16.parquet, /testdata/tpch/plan_sf1/nation/2.parquet], [/testdata/tpch/plan_sf1/nation/3.parquet, /testdata/tpch/plan_sf1/nation/4.parquet, /testdata/tpch/plan_sf1/nation/5.parquet], [/testdata/tpch/plan_sf1/nation/6.parquet, /testdata/tpch/plan_sf1/nation/7.parquet, /testdata/tpch/plan_sf1/nation/8.parquet], ...]}, projection=[n_nationkey, n_regionkey], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
    ...
    async fn test_tpch_3() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │         DataSourceExec: file_groups={18 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_custkey, o_orderdate, o_shippriority], file_type=parquet, predicate=o_orderdate@4 < 1995-03-15 AND DynamicFilter [ empty ], pruning_predicate=o_orderdate_null_count@1 != row_count@2 AND o_orderdate_min@0 < 1995-03-15, required_guarantees=[]
            └──────────────────────────────────────────────────
              ...
              │     DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/customer/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/7.parquet:<int>..<int>], ...]}, projection=[c_custkey, c_mktsegment], file_type=parquet, predicate=c_mktsegment@6 = BUILDING, pruning_predicate=c_mktsegment_null_count@2 != row_count@3 AND c_mktsegment_min@0 <= BUILDING AND BUILDING <= c_mktsegment_max@1, required_guarantees=[c_mktsegment in (BUILDING)]
              └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_4() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       [Stage 3] => NetworkShuffleExec: output_partitions=6, input_tasks=2
          └──────────────────────────────────────────────────
            ┌───── Stage 3 ── Tasks: t0:[p0..p23] t1:[p0..p23] 
            ...
            └──────────────────────────────────────────────────
              ...
              │ RepartitionExec: partitioning=Hash([o_orderkey@0], 12), input_partitions=6
    ...
    async fn test_tpch_5() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │     DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/region/1.parquet, /testdata/tpch/plan_sf1/region/10.parquet, /testdata/tpch/plan_sf1/region/11.parquet], [/testdata/tpch/plan_sf1/region/12.parquet, /testdata/tpch/plan_sf1/region/13.parquet, /testdata/tpch/plan_sf1/region/14.parquet], [/testdata/tpch/plan_sf1/region/15.parquet, /testdata/tpch/plan_sf1/region/16.parquet, /testdata/tpch/plan_sf1/region/2.parquet], [/testdata/tpch/plan_sf1/region/3.parquet, /testdata/tpch/plan_sf1/region/4.parquet, /testdata/tpch/plan_sf1/region/5.parquet], [/testdata/tpch/plan_sf1/region/6.parquet, /testdata/tpch/plan_sf1/region/7.parquet, /testdata/tpch/plan_sf1/region/8.parquet], ...]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = ASIA, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= ASIA AND ASIA <= r_name_max@1, required_guarantees=[r_name in (ASIA)]
            └──────────────────────────────────────────────────
            ...
            │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │     DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_orderkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_7() -> Result<(), Box<dyn Error>> {
        ...
        │                         RepartitionExec: partitioning=Hash([c_custkey@0], 6), input_partitions=6
        │                           DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/customer/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/7.parquet:<int>..<int>], ...]}, projection=[c_custkey, c_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
        │                         [Stage 4] => NetworkShuffleExec: output_partitions=6, input_tasks=2
        └──────────────────────────────────────────────────
          ┌───── Stage 4 ── Tasks: t0:[p0..p5] t1:[p0..p5] 
          ...
          │       [Stage 1] => NetworkShuffleExec: output_partitions=6, input_tasks=2
          │       [Stage 3] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p11] t1:[p0..p11] 
            │ RepartitionExec: partitioning=Hash([o_orderkey@0], 12), input_partitions=6
            │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │     DataSourceExec: file_groups={12 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/15.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_custkey], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
            ┌───── Stage 3 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11] t3:[p0..p11] 
            │ RepartitionExec: partitioning=Hash([l_orderkey@1], 12), input_partitions=6
            ...
            │       PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │         DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_orderkey, l_suppkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@10 >= 1995-01-01 AND l_shipdate@10 <= 1996-12-31 AND DynamicFilter [ empty ] AND DynamicFilter [ empty ], pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1995-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 <= 1996-12-31, required_guarantees=[]
            └──────────────────────────────────────────────────
              ┌───── Stage 2 ── Tasks: t0:[p0..p23] 
              │ BroadcastExec: input_partitions=6, consumer_tasks=4, output_partitions=24
              │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/supplier/1.parquet, /testdata/tpch/plan_sf1/supplier/10.parquet, /testdata/tpch/plan_sf1/supplier/11.parquet], [/testdata/tpch/plan_sf1/supplier/12.parquet, /testdata/tpch/plan_sf1/supplier/13.parquet, /testdata/tpch/plan_sf1/supplier/14.parquet], [/testdata/tpch/plan_sf1/supplier/15.parquet, /testdata/tpch/plan_sf1/supplier/16.parquet, /testdata/tpch/plan_sf1/supplier/2.parquet], [/testdata/tpch/plan_sf1/supplier/3.parquet, /testdata/tpch/plan_sf1/supplier/4.parquet, /testdata/tpch/plan_sf1/supplier/5.parquet], [/testdata/tpch/plan_sf1/supplier/6.parquet, /testdata/tpch/plan_sf1/supplier/7.parquet, /testdata/tpch/plan_sf1/supplier/8.parquet], ...]}, projection=[s_suppkey, s_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
    ...
    async fn test_tpch_8() -> Result<(), Box<dyn Error>> {
        ...
        │                       DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/region/1.parquet, /testdata/tpch/plan_sf1/region/10.parquet, /testdata/tpch/plan_sf1/region/11.parquet], [/testdata/tpch/plan_sf1/region/12.parquet, /testdata/tpch/plan_sf1/region/13.parquet, /testdata/tpch/plan_sf1/region/14.parquet], [/testdata/tpch/plan_sf1/region/15.parquet, /testdata/tpch/plan_sf1/region/16.parquet, /testdata/tpch/plan_sf1/region/2.parquet], [/testdata/tpch/plan_sf1/region/3.parquet, /testdata/tpch/plan_sf1/region/4.parquet, /testdata/tpch/plan_sf1/region/5.parquet], [/testdata/tpch/plan_sf1/region/6.parquet, /testdata/tpch/plan_sf1/region/7.parquet, /testdata/tpch/plan_sf1/region/8.parquet], ...]}, projection=[r_regionkey, r_name], file_type=parquet, predicate=r_name@1 = AMERICA, pruning_predicate=r_name_null_count@2 != row_count@3 AND r_name_min@0 <= AMERICA AND AMERICA <= r_name_max@1, required_guarantees=[r_name in (AMERICA)]
        ...
        │                     CoalescePartitionsExec
        │                       BroadcastExec: input_partitions=6, consumer_tasks=1, output_partitions=6
        │                         DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/nation/1.parquet, /testdata/tpch/plan_sf1/nation/10.parquet, /testdata/tpch/plan_sf1/nation/11.parquet], [/testdata/tpch/plan_sf1/nation/12.parquet, /testdata/tpch/plan_sf1/nation/13.parquet, /testdata/tpch/plan_sf1/nation/14.parquet], [/testdata/tpch/plan_sf1/nation/15.parquet, /testdata/tpch/plan_sf1/nation/16.parquet, /testdata/tpch/plan_sf1/nation/2.parquet], [/testdata/tpch/plan_sf1/nation/3.parquet, /testdata/tpch/plan_sf1/nation/4.parquet, /testdata/tpch/plan_sf1/nation/5.parquet], [/testdata/tpch/plan_sf1/nation/6.parquet, /testdata/tpch/plan_sf1/nation/7.parquet, /testdata/tpch/plan_sf1/nation/8.parquet], ...]}, projection=[n_nationkey, n_name], file_type=parquet
        ...
        └──────────────────────────────────────────────────
          ...
          │           [Stage 3] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=24, input_tasks=1
          │         PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
          │           DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_orderkey, l_partkey, l_suppkey, l_extendedprice, l_discount], file_type=parquet, predicate=DynamicFilter [ empty ] AND DynamicFilter [ empty ] AND DynamicFilter [ empty ]
          └──────────────────────────────────────────────────
            ┌───── Stage 2 ── Tasks: t0:[p0..p23] 
            │ BroadcastExec: input_partitions=6, consumer_tasks=4, output_partitions=24
            │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/supplier/1.parquet, /testdata/tpch/plan_sf1/supplier/10.parquet, /testdata/tpch/plan_sf1/supplier/11.parquet], [/testdata/tpch/plan_sf1/supplier/12.parquet, /testdata/tpch/plan_sf1/supplier/13.parquet, /testdata/tpch/plan_sf1/supplier/14.parquet], [/testdata/tpch/plan_sf1/supplier/15.parquet, /testdata/tpch/plan_sf1/supplier/16.parquet, /testdata/tpch/plan_sf1/supplier/2.parquet], [/testdata/tpch/plan_sf1/supplier/3.parquet, /testdata/tpch/plan_sf1/supplier/4.parquet, /testdata/tpch/plan_sf1/supplier/5.parquet], [/testdata/tpch/plan_sf1/supplier/6.parquet, /testdata/tpch/plan_sf1/supplier/7.parquet, /testdata/tpch/plan_sf1/supplier/8.parquet], ...]}, projection=[s_suppkey, s_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
    ...
    async fn test_tpch_9() -> Result<(), Box<dyn Error>> {
        ...
        │         [Stage 8] => NetworkShuffleExec: output_partitions=6, input_tasks=2
        └──────────────────────────────────────────────────
          ...
          │             [Stage 7] => NetworkShuffleExec: output_partitions=6, input_tasks=2
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p11] 
            │ BroadcastExec: input_partitions=6, consumer_tasks=2, output_partitions=12
            │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/nation/1.parquet, /testdata/tpch/plan_sf1/nation/10.parquet, /testdata/tpch/plan_sf1/nation/11.parquet], [/testdata/tpch/plan_sf1/nation/12.parquet, /testdata/tpch/plan_sf1/nation/13.parquet, /testdata/tpch/plan_sf1/nation/14.parquet], [/testdata/tpch/plan_sf1/nation/15.parquet, /testdata/tpch/plan_sf1/nation/16.parquet, /testdata/tpch/plan_sf1/nation/2.parquet], [/testdata/tpch/plan_sf1/nation/3.parquet, /testdata/tpch/plan_sf1/nation/4.parquet, /testdata/tpch/plan_sf1/nation/5.parquet], [/testdata/tpch/plan_sf1/nation/6.parquet, /testdata/tpch/plan_sf1/nation/7.parquet, /testdata/tpch/plan_sf1/nation/8.parquet], ...]}, projection=[n_nationkey, n_name], file_type=parquet
            ...
            ┌───── Stage 2 ── Tasks: t0:[p0..p11] 
            │ RepartitionExec: partitioning=Hash([o_orderkey@0], 12), input_partitions=6
            │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/2.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/7.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_orderdate], file_type=parquet
            └──────────────────────────────────────────────────
            ┌───── Stage 7 ── Tasks: t0:[p0..p11] t1:[p0..p11] 
            │ RepartitionExec: partitioning=Hash([l_orderkey@0], 12), input_partitions=6
            ...
            └──────────────────────────────────────────────────
              ...
              │ RepartitionExec: partitioning=Hash([ps_suppkey@1, ps_partkey@0], 12), input_partitions=6
              │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
              │     DataSourceExec: file_groups={12 groups: [[/testdata/tpch/plan_sf1/partsupp/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/15.parquet:<int>..<int>], ...]}, projection=[ps_partkey, ps_suppkey, ps_supplycost], file_type=parquet
              └──────────────────────────────────────────────────
              ┌───── Stage 6 ── Tasks: t0:[p0..p11] t1:[p0..p11] t2:[p0..p11] t3:[p0..p11] 
              │ RepartitionExec: partitioning=Hash([l_suppkey@2, l_partkey@1], 12), input_partitions=6
              ...
              │         PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
              │           DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_orderkey, l_partkey, l_suppkey, l_quantity, l_extendedprice, l_discount], file_type=parquet, predicate=DynamicFilter [ empty ] AND DynamicFilter [ empty ] AND DynamicFilter [ empty ] AND DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
                ...
                │     DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/part/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/7.parquet:<int>..<int>], ...]}, projection=[p_partkey, p_name], file_type=parquet, predicate=p_name@1 LIKE %green%
                └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_10() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/nation/1.parquet, /testdata/tpch/plan_sf1/nation/10.parquet, /testdata/tpch/plan_sf1/nation/11.parquet], [/testdata/tpch/plan_sf1/nation/12.parquet, /testdata/tpch/plan_sf1/nation/13.parquet, /testdata/tpch/plan_sf1/nation/14.parquet], [/testdata/tpch/plan_sf1/nation/15.parquet, /testdata/tpch/plan_sf1/nation/16.parquet, /testdata/tpch/plan_sf1/nation/2.parquet], [/testdata/tpch/plan_sf1/nation/3.parquet, /testdata/tpch/plan_sf1/nation/4.parquet, /testdata/tpch/plan_sf1/nation/5.parquet], [/testdata/tpch/plan_sf1/nation/6.parquet, /testdata/tpch/plan_sf1/nation/7.parquet, /testdata/tpch/plan_sf1/nation/8.parquet], ...]}, projection=[n_nationkey, n_name], file_type=parquet
            └──────────────────────────────────────────────────
            ┌───── Stage 4 ── Tasks: t0:[p0..p17] t1:[p0..p17] 
            │ RepartitionExec: partitioning=Hash([o_orderkey@7], 18), input_partitions=6
            ...
            └──────────────────────────────────────────────────
              ┌───── Stage 2 ── Tasks: t0:[p0..p11] 
              │ RepartitionExec: partitioning=Hash([c_custkey@0], 12), input_partitions=6
              │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/customer/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/7.parquet:<int>..<int>], ...]}, projection=[c_custkey, c_name, c_address, c_nationkey, c_phone, c_acctbal, c_comment], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
              ┌───── Stage 3 ── Tasks: t0:[p0..p11] t1:[p0..p11] 
              │ RepartitionExec: partitioning=Hash([o_custkey@1], 12), input_partitions=6
    ...
    async fn test_tpch_11() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │           [Stage 2] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=12, input_tasks=1
          │         PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
          │           DataSourceExec: file_groups={12 groups: [[/testdata/tpch/plan_sf1/partsupp/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/15.parquet:<int>..<int>], ...]}, projection=[ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet, predicate=DynamicFilter [ empty ]
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p11] 
            │ BroadcastExec: input_partitions=6, consumer_tasks=2, output_partitions=12
          ...
          │           PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
          │             DataSourceExec: file_groups={12 groups: [[/testdata/tpch/plan_sf1/partsupp/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/15.parquet:<int>..<int>], ...]}, projection=[ps_partkey, ps_suppkey, ps_availqty, ps_supplycost], file_type=parquet, predicate=DynamicFilter [ empty ]
          └──────────────────────────────────────────────────
            ┌───── Stage 4 ── Tasks: t0:[p0..p11] 
            │ BroadcastExec: input_partitions=6, consumer_tasks=2, output_partitions=12
            │   FilterExec: n_name@1 = GERMANY, projection=[n_nationkey@0]
    ...
    async fn test_tpch_12() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │       [Stage 1] => NetworkShuffleExec: output_partitions=6, input_tasks=4
            │       [Stage 2] => NetworkShuffleExec: output_partitions=6, input_tasks=2
            └──────────────────────────────────────────────────
              ┌───── Stage 1 ── Tasks: t0:[p0..p23] t1:[p0..p23] t2:[p0..p23] t3:[p0..p23] 
              │ RepartitionExec: partitioning=Hash([l_orderkey@0], 24), input_partitions=6
              ...
              │     PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
              │       DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_orderkey, l_shipdate, l_commitdate, l_receiptdate, l_shipmode], file_type=parquet, predicate=(l_shipmode@14 = MAIL OR l_shipmode@14 = SHIP) AND l_receiptdate@12 > l_commitdate@11 AND l_shipdate@10 < l_commitdate@11 AND l_receiptdate@12 >= 1994-01-01 AND l_receiptdate@12 < 1995-01-01, pruning_predicate=(l_shipmode_null_count@2 != row_count@3 AND l_shipmode_min@0 <= MAIL AND MAIL <= l_shipmode_max@1 OR l_shipmode_null_count@2 != row_count@3 AND l_shipmode_min@0 <= SHIP AND SHIP <= l_shipmode_max@1) AND l_receiptdate_null_count@5 != row_count@3 AND l_receiptdate_max@4 >= 1994-01-01 AND l_receiptdate_null_count@5 != row_count@3 AND l_receiptdate_min@6 < 1995-01-01, required_guarantees=[l_shipmode in (MAIL, SHIP)]
              └──────────────────────────────────────────────────
              ┌───── Stage 2 ── Tasks: t0:[p0..p23] t1:[p0..p23] 
              │ RepartitionExec: partitioning=Hash([o_orderkey@0], 24), input_partitions=6
              │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
              │     DataSourceExec: file_groups={12 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/15.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_orderpriority], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
    ...
    async fn test_tpch_13() -> Result<(), Box<dyn Error>> {
        ...
        │                   RepartitionExec: partitioning=Hash([c_custkey@0], 6), input_partitions=6
        │                     DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/customer/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/7.parquet:<int>..<int>], ...]}, projection=[c_custkey], file_type=parquet
        │                   [Stage 1] => NetworkShuffleExec: output_partitions=6, input_tasks=3
        └──────────────────────────────────────────────────
          ...
          │     PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
          │       DataSourceExec: file_groups={18 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_custkey, o_comment], file_type=parquet, predicate=o_comment@8 NOT LIKE %special%requests%
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_14() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          │       [Stage 1] => NetworkShuffleExec: output_partitions=6, input_tasks=1
          │       [Stage 2] => NetworkShuffleExec: output_partitions=6, input_tasks=4
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p17] 
            │ RepartitionExec: partitioning=Hash([p_partkey@0], 18), input_partitions=6
            │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/part/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/7.parquet:<int>..<int>], ...]}, projection=[p_partkey, p_type], file_type=parquet
            └──────────────────────────────────────────────────
            ┌───── Stage 2 ── Tasks: t0:[p0..p17] t1:[p0..p17] t2:[p0..p17] t3:[p0..p17] 
            │ RepartitionExec: partitioning=Hash([l_partkey@0], 18), input_partitions=6
            │   FilterExec: l_shipdate@3 >= 1995-09-01 AND l_shipdate@3 < 1995-10-01, projection=[l_partkey@0, l_extendedprice@1, l_discount@2]
            │     PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │       DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_partkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@10 >= 1995-09-01 AND l_shipdate@10 < 1995-10-01 AND DynamicFilter [ empty ], pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1995-09-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1995-10-01, required_guarantees=[]
            └──────────────────────────────────────────────────
        "#);
        Ok(())
    }
          ...
          └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ...
              └──────────────────────────────────────────────────
                ...
                │       PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
                │         DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_suppkey, l_extendedprice, l_discount, l_shipdate], file_type=parquet, predicate=l_shipdate@10 >= 1996-01-01 AND l_shipdate@10 < 1996-04-01, pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1996-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1996-04-01, required_guarantees=[]
                └──────────────────────────────────────────────────
            ┌───── Stage 4 ── Tasks: t0:[p0..p17] 
            │ BroadcastExec: input_partitions=6, consumer_tasks=3, output_partitions=18
            │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/supplier/1.parquet, /testdata/tpch/plan_sf1/supplier/10.parquet, /testdata/tpch/plan_sf1/supplier/11.parquet], [/testdata/tpch/plan_sf1/supplier/12.parquet, /testdata/tpch/plan_sf1/supplier/13.parquet, /testdata/tpch/plan_sf1/supplier/14.parquet], [/testdata/tpch/plan_sf1/supplier/15.parquet, /testdata/tpch/plan_sf1/supplier/16.parquet, /testdata/tpch/plan_sf1/supplier/2.parquet], [/testdata/tpch/plan_sf1/supplier/3.parquet, /testdata/tpch/plan_sf1/supplier/4.parquet, /testdata/tpch/plan_sf1/supplier/5.parquet], [/testdata/tpch/plan_sf1/supplier/6.parquet, /testdata/tpch/plan_sf1/supplier/7.parquet, /testdata/tpch/plan_sf1/supplier/8.parquet], ...]}, projection=[s_suppkey, s_name, s_address, s_phone], file_type=parquet
            └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p17] t1:[p0..p17] t2:[p0..p17] t3:[p0..p17] 
            │ RepartitionExec: partitioning=Hash([l_suppkey@0], 18), input_partitions=6
            │   AggregateExec: mode=Partial, gby=[l_suppkey@0 as l_suppkey], aggr=[sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)]
                          ...
                          HashJoinExec: mode=CollectLeft, join_type=RightAnti, on=[(s_suppkey@0, ps_suppkey@0)]
                            CoalescePartitionsExec
                              FilterExec: s_comment@1 LIKE %Customer%Complaints%, projection=[s_suppkey@0]
                                DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/supplier/1.parquet, /testdata/tpch/plan_sf1/supplier/10.parquet, /testdata/tpch/plan_sf1/supplier/11.parquet], [/testdata/tpch/plan_sf1/supplier/12.parquet, /testdata/tpch/plan_sf1/supplier/13.parquet, /testdata/tpch/plan_sf1/supplier/14.parquet], [/testdata/tpch/plan_sf1/supplier/15.parquet, /testdata/tpch/plan_sf1/supplier/16.parquet, /testdata/tpch/plan_sf1/supplier/2.parquet], [/testdata/tpch/plan_sf1/supplier/3.parquet, /testdata/tpch/plan_sf1/supplier/4.parquet, /testdata/tpch/plan_sf1/supplier/5.parquet], [/testdata/tpch/plan_sf1/supplier/6.parquet, /testdata/tpch/plan_sf1/supplier/7.parquet, /testdata/tpch/plan_sf1/supplier/8.parquet], [/testdata/tpch/plan_sf1/supplier/9.parquet]]}, projection=[s_suppkey, s_comment], file_type=parquet, predicate=s_comment@6 LIKE %Customer%Complaints%
    ...
    async fn test_tpch_17() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │         [Stage 1] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=24, input_tasks=1
            │       PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │         DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_partkey, l_quantity, l_extendedprice], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
              ┌───── Stage 1 ── Tasks: t0:[p0..p23] 
              │ BroadcastExec: input_partitions=6, consumer_tasks=4, output_partitions=24
              │   FilterExec: p_brand@1 = Brand#23 AND p_container@2 = MED BOX, projection=[p_partkey@0]
              │     DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/part/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/7.parquet:<int>..<int>], ...]}, projection=[p_partkey, p_brand, p_container], file_type=parquet, predicate=p_brand@3 = Brand#23 AND p_container@6 = MED BOX, pruning_predicate=p_brand_null_count@2 != row_count@3 AND p_brand_min@0 <= Brand#23 AND Brand#23 <= p_brand_max@1 AND p_container_null_count@6 != row_count@3 AND p_container_min@4 <= MED BOX AND MED BOX <= p_container_max@5, required_guarantees=[p_brand in (Brand#23), p_container in (MED BOX)]
              └──────────────────────────────────────────────────
            ┌───── Stage 3 ── Tasks: t0:[p0..p23] t1:[p0..p23] t2:[p0..p23] t3:[p0..p23] 
            ...
            │     PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │       DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_partkey, l_quantity], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_18() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │     PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │       DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_orderkey, l_quantity], file_type=parquet
            └──────────────────────────────────────────────────
            ...
            └──────────────────────────────────────────────────
              ...
              │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/customer/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/7.parquet:<int>..<int>], ...]}, projection=[c_custkey, c_name], file_type=parquet
              └──────────────────────────────────────────────────
              ┌───── Stage 3 ── Tasks: t0:[p0..p17] t1:[p0..p17] t2:[p0..p17] 
              │ RepartitionExec: partitioning=Hash([o_custkey@1], 18), input_partitions=6
              │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
              │     DataSourceExec: file_groups={18 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>], ...]}, projection=[o_orderkey, o_custkey, o_totalprice, o_orderdate], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p23] t1:[p0..p23] t2:[p0..p23] t3:[p0..p23] 
            │ RepartitionExec: partitioning=Hash([l_orderkey@0], 24), input_partitions=6
            │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │     DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_orderkey, l_quantity], file_type=parquet, predicate=DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_20() -> Result<(), Box<dyn Error>> {
        ...
        │                 DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/nation/1.parquet, /testdata/tpch/plan_sf1/nation/10.parquet, /testdata/tpch/plan_sf1/nation/11.parquet], [/testdata/tpch/plan_sf1/nation/12.parquet, /testdata/tpch/plan_sf1/nation/13.parquet, /testdata/tpch/plan_sf1/nation/14.parquet], [/testdata/tpch/plan_sf1/nation/15.parquet, /testdata/tpch/plan_sf1/nation/16.parquet, /testdata/tpch/plan_sf1/nation/2.parquet], [/testdata/tpch/plan_sf1/nation/3.parquet, /testdata/tpch/plan_sf1/nation/4.parquet, /testdata/tpch/plan_sf1/nation/5.parquet], [/testdata/tpch/plan_sf1/nation/6.parquet, /testdata/tpch/plan_sf1/nation/7.parquet, /testdata/tpch/plan_sf1/nation/8.parquet], ...]}, projection=[n_nationkey, n_name], file_type=parquet, predicate=n_name@1 = CANADA, pruning_predicate=n_name_null_count@2 != row_count@3 AND n_name_min@0 <= CANADA AND CANADA <= n_name_max@1, required_guarantees=[n_name in (CANADA)]
        │           DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/supplier/1.parquet, /testdata/tpch/plan_sf1/supplier/10.parquet, /testdata/tpch/plan_sf1/supplier/11.parquet], [/testdata/tpch/plan_sf1/supplier/12.parquet, /testdata/tpch/plan_sf1/supplier/13.parquet, /testdata/tpch/plan_sf1/supplier/14.parquet], [/testdata/tpch/plan_sf1/supplier/15.parquet, /testdata/tpch/plan_sf1/supplier/16.parquet, /testdata/tpch/plan_sf1/supplier/2.parquet], [/testdata/tpch/plan_sf1/supplier/3.parquet, /testdata/tpch/plan_sf1/supplier/4.parquet, /testdata/tpch/plan_sf1/supplier/5.parquet], [/testdata/tpch/plan_sf1/supplier/6.parquet, /testdata/tpch/plan_sf1/supplier/7.parquet, /testdata/tpch/plan_sf1/supplier/8.parquet], ...]}, projection=[s_suppkey, s_name, s_address, s_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
        ...
        └──────────────────────────────────────────────────
          ...
          │       [Stage 1] => NetworkBroadcastExec: partitions_per_consumer=6, stage_partitions=12, input_tasks=1
          │     PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
          │       DataSourceExec: file_groups={12 groups: [[/testdata/tpch/plan_sf1/partsupp/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/partsupp/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/partsupp/15.parquet:<int>..<int>], ...]}, projection=[ps_partkey, ps_suppkey, ps_availqty], file_type=parquet
          └──────────────────────────────────────────────────
            ┌───── Stage 1 ── Tasks: t0:[p0..p11] 
            │ BroadcastExec: input_partitions=6, consumer_tasks=2, output_partitions=12
            │   FilterExec: p_name@1 LIKE forest%, projection=[p_partkey@0]
            │     DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/part/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/part/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/part/7.parquet:<int>..<int>], ...]}, projection=[p_partkey, p_name], file_type=parquet, predicate=p_name@1 LIKE forest%, pruning_predicate=p_name_null_count@2 != row_count@3 AND p_name_min@0 <= foresu AND forest <= p_name_max@1, required_guarantees=[]
            └──────────────────────────────────────────────────
          ┌───── Stage 3 ── Tasks: t0:[p0..p5] t1:[p0..p5] t2:[p0..p5] t3:[p0..p5] 
          ...
          │       PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
          │         DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_partkey, l_suppkey, l_quantity, l_shipdate], file_type=parquet, predicate=l_shipdate@10 >= 1994-01-01 AND l_shipdate@10 < 1995-01-01 AND DynamicFilter [ empty ], pruning_predicate=l_shipdate_null_count@1 != row_count@2 AND l_shipdate_max@0 >= 1994-01-01 AND l_shipdate_null_count@1 != row_count@2 AND l_shipdate_min@3 < 1995-01-01, required_guarantees=[]
          └──────────────────────────────────────────────────
        ");
        Ok(())
    }
    ...
    async fn test_tpch_21() -> Result<(), Box<dyn Error>> {
        ...
        └──────────────────────────────────────────────────
          ...
          └──────────────────────────────────────────────────
            ...
            │       PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │         DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_orderkey, l_suppkey, l_commitdate, l_receiptdate], file_type=parquet, predicate=l_receiptdate@12 > l_commitdate@11 AND DynamicFilter [ empty ] AND DynamicFilter [ empty ]
            └──────────────────────────────────────────────────
              ┌───── Stage 3 ── Tasks: t0:[p0..p23] 
              │ BroadcastExec: input_partitions=6, consumer_tasks=4, output_partitions=24
              │   DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/supplier/1.parquet, /testdata/tpch/plan_sf1/supplier/10.parquet, /testdata/tpch/plan_sf1/supplier/11.parquet], [/testdata/tpch/plan_sf1/supplier/12.parquet, /testdata/tpch/plan_sf1/supplier/13.parquet, /testdata/tpch/plan_sf1/supplier/14.parquet], [/testdata/tpch/plan_sf1/supplier/15.parquet, /testdata/tpch/plan_sf1/supplier/16.parquet, /testdata/tpch/plan_sf1/supplier/2.parquet], [/testdata/tpch/plan_sf1/supplier/3.parquet, /testdata/tpch/plan_sf1/supplier/4.parquet, /testdata/tpch/plan_sf1/supplier/5.parquet], [/testdata/tpch/plan_sf1/supplier/6.parquet, /testdata/tpch/plan_sf1/supplier/7.parquet, /testdata/tpch/plan_sf1/supplier/8.parquet], ...]}, projection=[s_suppkey, s_name, s_nationkey], file_type=parquet, predicate=DynamicFilter [ empty ]
              └──────────────────────────────────────────────────
            ┌───── Stage 5 ── Tasks: t0:[p0..p23] t1:[p0..p23] t2:[p0..p23] t3:[p0..p23] 
            │ RepartitionExec: partitioning=Hash([l_orderkey@0], 24), input_partitions=6
            │   PartitionIsolatorExec: t0:[p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__] t1:[__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__,__,__,__,__,__,__] t2:[__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5,__,__,__,__,__,__] t3:[__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,__,p0,p1,p2,p3,p4,p5]
            │     DataSourceExec: file_groups={24 groups: [[/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/lineitem/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/lineitem/12.parquet:<int>..<int>], ...]}, projection=[l_orderkey, l_suppkey], file_type=parquet
            └──────────────────────────────────────────────────
            ┌───── Stage 6 ── Tasks: t0:[p0..p23] t1:[p0..p23] t2:[p0..p23] t3:[p0..p23] 
            │ RepartitionExec: partitioning=Hash([l_orderkey@0], 24), input_partitions=6
            │   FilterExec: l_receiptdate@3 > l_commitdate@2, projection=[l_orderkey@0, l_suppkey@1]
                          ...
                          HashJoinExec: mode=CollectLeft, join_type=LeftAnti, on=[(c_custkey@0, o_custkey@0)], projection=[c_phone@1, c_acctbal@2]
                            CoalescePartitionsExec
                              FilterExec: substr(c_phone@1, 1, 2) IN (SET) ([13, 31, 23, 29, 30, 18, 17])
                                DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/customer/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/7.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/customer/7.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/8.parquet:<int>..<int>, /testdata/tpch/plan_sf1/customer/9.parquet:<int>..<int>]]}, projection=[c_custkey, c_phone, c_acctbal], file_type=parquet, predicate=substr(c_phone@4, 1, 2) IN (SET) ([13, 31, 23, 29, 30, 18, 17])
                            DataSourceExec: file_groups={6 groups: [[/testdata/tpch/plan_sf1/orders/1.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/10.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/11.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/12.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/13.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/14.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/15.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/16.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/2.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/2.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/3.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/4.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/4.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/5.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/6.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/7.parquet:<int>..<int>], [/testdata/tpch/plan_sf1/orders/7.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/8.parquet:<int>..<int>, /testdata/tpch/plan_sf1/orders/9.parquet:<int>..<int>]]}, projection=[o_custkey], file_type=parquet
        ");
        Ok(())
    }
